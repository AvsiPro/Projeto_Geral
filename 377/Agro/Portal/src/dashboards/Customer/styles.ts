...
import { MdOutlineAssignmentLate, MdOutlineDescription } from 'react-icons/md';
...
export const IconEmAtraso = styled(MdOutlineAssignmentLate)`
    color: #ff5b51!important;
    filter:drop-shadow(0px 4px 4px rgba(255,91,81,.3));
    margin-right:10px;
`

export const IconEmAberto = styled(MdOutlineDescription)`
    color: #2dce89!important;
    filter:drop-shadow(0px 4px 4px rgba(45,206,137,.3));
    margin-right:10px;
`

export const IconAVencer = styled(TbFileDollar)`
    color: #ffc107!important;
    filter:drop-shadow(0px 4px 4px rgba(197, 197, 37, 0.3));
    margin-right:10px;
`
