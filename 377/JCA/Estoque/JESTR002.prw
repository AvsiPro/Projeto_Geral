...
oDlg1      := MSDialog():New( 186,980,914,1624,"Etiqueta de Produto",,,.F.,,,,,,.T.,,,.T. )
	...
	oSay2      := TSay():New( 029,044,{||"Armazém Ate ?"},oDlg1,,,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,039,008)
	...
	oSay5      := TSay():New( 080,044,{||"Endereço de ?"},oDlg1,,,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,039,008)
	oGet5      := TGet():New( 080,132,{|u| If(Pcount()>0,cPar05:=u,cPar05)},oDlg1,060,008,'',,CLR_BLACK,CLR_WHITE,,,,.T.,"",,,.F.,.F.,,.F.,.F.,"SBE","",,)
	
	oSay6      := TSay():New( 097,044,{||"Endereço Ate ?"},oDlg1,,,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,039,008)
	...
	oSay9      := TSay():New( 165,044,{||"Cód. Fornecedor"},oDlg1,,,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,048,008)
	...
	oGrp1      := TGroup():New( 233,024,336,300,"Itens NF",oDlg1,CLR_BLACK,CLR_WHITE,.T.,.F. )
		...
		//							256
		oList    := TCBrowse():New(241,028,268,075,, {'Código','Descrição','Qtd NF','Qtd Etiquetas'},;
                                                        {40,60,40,40},;
