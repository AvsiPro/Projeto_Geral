/*
    Ponto de entrada SPEDRTMS tem como finalidade permitir a manipula��o com as informa��es 
    envolvendo Conhecimentos de Transporte para os clientes que possuem movimentos gerados 
    sem integra��o com o ambiente SIGATMS - Gest�o de Transportes
    Foi utilizado para gera��o dos registros D no sped fiscal
*/
