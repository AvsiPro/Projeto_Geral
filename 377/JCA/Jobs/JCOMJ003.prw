#INCLUDE 'PROTHEUS.CH'
/*
    Job que faz Processamento rotina pre-requisi��o de forma autom�tica
    MIT 44_ESTOQUE_EST012 - Processamento rotina gerar pre-requisi��o de forma autom�tica
...
For n1Cnt := 1 to Len(aSolicit)
    ...
    U_JGENX002(cEmailTst,'Solicitação de peças disponíveis',cMensagem,'',.F.)
