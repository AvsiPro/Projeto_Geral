...
/*/{Protheus.doc} JCTBJ001
   ...
   Doc Mit
    https://docs.google.com/document/d/1IsoHmq4oyRmA3rdM4p-SBjUpkrtT_9s_/edit
    Doc Entrega
    https://docs.google.com/document/d/1mdBGGtIY0_xJMfizlurvBkGeuA5NCrYE/edit

/*/
User Function JCTBJ001(xEmp, xFi, lJob)
    ...
    While (cAliasTMP)->(!EoF())
        ...
        If lMsErroAuto
            If lJob
                MostraErro('\system\','JCTBJ001_'+DToS(dDataBase)+StrTran(cValToChar(Time()),":"))
            Else
