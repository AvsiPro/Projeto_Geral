...
±±³Fun‡…o    ³ JFISR001  ³ Autor ³ Alexandre Venancio  ³ Data ³20/09/2023 ³±±
...
oReport := TReport():New("JFISR001",cTitle,If(lAuto,Nil,"JFISR001"), {|oReport| ReportPrint(oReport)},"") 
