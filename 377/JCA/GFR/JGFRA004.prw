...
cQuery += " INNER JOIN "+RetSQLName("TQF")+" TQF ON TQF_FILIAL='"+xFilial("TQF")+"' AND TQF_CODIGO=TQN_POSTO AND TQF_TIPPOS='2' AND TQF.D_E_L_E_T_=' '"
...
cQuery += " INNER JOIN "+RetSQLName("TQF")+" TQF ON TQF_FILIAL='"+xFilial("TQF")+"' AND TQF_CODIGO=TTH_POSTO AND TQF.D_E_L_E_T_=' '"
