...
oDlg1    := MSDialog():New( 017,058,628,1344,"Pick-List",,,.F.,,,,,,.T.,,,.T. )
    ...
    oFld1    := TFolder():New( 000,284,{"Pick-List","Leituras"},{},oDlg1,,,,.T.,.F.,348,148,) 
        ...
        //oBrw5      := MsSelect():New( "","","",{{"","","Title",""}},.F.,,{000,000,132,344},,, oFld1:aDialogs[4] ) 
                                                                                                   //,"oaDialogs10"
    oFld2    := TFolder():New( 152,004,{"Produtos","MAPAS","Locais Inst.","Rotas","Cโnisteres"},{},oDlg1,,,,.T.,.F.,276,132,) 
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAVSIINT   บAutor  ณMicrosiga           บ Data ณ  08/13/18   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
oSaySld:settext("")
oSaySld:settext("Total   "+cvaltochar(nTotal)+"   /   Diferen็a para Saldo   "+cvaltochar(nTotal-aSaldo1[oSaldo1:nAt,04]))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAVSIINT   บAutor  ณMicrosiga           บ Data ณ  05/08/19   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
IF len(aPeriodo) == 0
    MsgAlert("Nใo encontrado um periodo de competencia aberto, favor verificar")
...
IF nOpc == 1
    IF MsgYesNo("Confirma a c๓pia do MAPA atual para as maquinas selecionadas?","repplan - AVSIINT")
        ...
        MsgAlert("MAPAS salvos, saia da rotina e abra novamente para atualiza็ใo.")
    ENDIF
ENDIF
