...
If lDesvio
	MsgAlert("Contrato com desvio de leitura, as doses cobradas serใo reajustadas em "+CVALTOCHAR(aList[oList:nAt,26])+"%")
...
For nCont := 1 to len(aEmail)
	If aEmail[nCont,01]
		...
		If Empty(cCnpjj)
			MsgAlert("CNPJ Invแlido para a nota "+MV_PAR02)
			exit
		EndIf 
