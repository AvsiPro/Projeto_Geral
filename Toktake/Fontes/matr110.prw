...
TRCell():New(oSection2,"DESCPROD"   ,"   ",STR0097   ,/*Picture*/,If(nTamCdProd>15,22,33),/*lPixel*/, {|| Left(cDescPro,If(nTamCdProd>15,22,33)) })
TRCell():New(oSection2,"C7_UM"      ,"SC7",STR0115   ,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"C7_SEGUM"   ,"SC7",STR0118,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
...
TRCell():New(oSection2,"PRECO"      ,"   ",STR0098,PesqPict("SC7","C7_PRECO",16, MsDecimais(MV_PAR12)),16/*Tamanho*/,/*lPixel*/,{|| nVlUnitSC7 })
TRCell():New(oSection2,"C7_IPI"     ,"SC7",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"TOTAL"      ,"   ",STR0099,PesqPict("SC7","C7_TOTAL",16,MsDecimais(MV_PAR12)),16/*Tamanho*/,/*lPixel*/,{|| nValTotSC7 })
	...
	For nVias := 1 to mv_par09
		...
		While !oReport:Cancel() .And. !SC7->(Eof()) .And. SC7->C7_FILIAL == xFilial("SC7") .And. SC7->C7_NUM == cNumSC7
			...
			If MV_PAR07 == 2 .And. !Empty(SC7->C7_QTSEGUM) .And. !Empty(SC7->C7_SEGUM)
				oSection2:Cell("C7_DATPRF"):SetTitle(STR0117) 
			...
			Else
				oSection2:Cell("C7_DATPRF"):SetTitle(STR0116)   
		...
		TransForm(xMoeda(nDescProd,SC7->C7_MOEDA,MV_PAR12,SC7->C7_DATPRF,MsDecimais(SC7->C7_MOEDA),nTxMoeda) , PesqPict("SC7","C7_VLDESC",14, MsDecimais(MV_PAR12)) ),;
		2022 , 050 )
...
nLinPC := oReport:Row()
oReport:PrintText(STR0089 + Trans(SM0->M0_CEPENT,PesqPict("SA2","A2_CEP"))+Space(2)+STR0090 + SM0->M0_CIDENT + STR0091 + SM0->M0_ESTENT ,nLinPC,15)
oReport:PrintText(STR0110+SA2->A2_MUN+" "+STR0111+SA2->A2_EST+" "+STR0112+SA2->A2_CEP+" "+STR0113+Transform(SA2->A2_CGC,PesqPict("SA2","A2_CGC")),nLinPC,1025)
oReport:SkipLine()
...
@ li,aColuna[3] PSAY "|"
If MV_PAR07 == 2 .And. !Empty(SC7->C7_QTSEGUM)
	@ li,PCOL()	PSAY xMoeda((SC7->C7_TOTAL/SC7->C7_QTSEGUM),SC7->C7_MOEDA,MV_PAR12,SC7->C7_DATPRF,MsDecimais(SC7->C7_MOEDA),nTxMoeda) Picture PesqPict("SC7","C7_PRECO",14, MsDecimais(MV_PAR12))
Else
	@ li,PCOL() PSAY xMoeda(SC7->C7_PRECO,SC7->C7_MOEDA,MV_PAR12,SC7->C7_DATPRF,MsDecimais(SC7->C7_MOEDA),nTxMoeda) Picture PesqPict("SC7","C7_PRECO",14,MsDecimais(MV_PAR12))
EndIf
@ li,aColuna[4] PSAY "|"
...
If mv_par08 == 1 .OR. mv_par08 == 3
	...
	Else
		...
		@ li,    PCOL() 	PSAY " "
	EndIf
	@ li,    PCOL() PSAY xMoeda(SC7->C7_TOTAL,SC7->C7_MOEDA,MV_PAR12,SC7->C7_DATPRF,MsDecimais(SC7->C7_MOEDA),nTxMoeda) Picture PesqPict("SC7","C7_TOTAL",16,MsDecimais(MV_PAR12))
	@ li,aColuna[6] PSAY "|"
...
@ li,068 PSAY xMoeda(nTotDesc,SC7->C7_MOEDA,MV_PAR12,SC7->C7_DATPRF,MsDecimais(SC7->C7_MOEDA),nTxMoeda) Picture PesqPict("SC7","C7_VLDESC",14, MsDecimais(MV_PAR12))
...
@ li,014 PSAY SC7->C7_REAJUST Picture PesqPict("SC7","c7_reajust",,MsDecimais(MV_PAR12))
