...
Local nLin           := 80
Local Cabec2         := " Cod.Produto.... Descricao do Produto.......... UN P. Bruto V.Cub... Qtd.Lib. Local. Lote...... Dt. Ent. Cod.PA Nome do PA.........." 
Local Cabec1         := ""
Local imprime        := .T.
Local aOrd            := {}
Private lEnd         := .F.
...
cQuery += " ORDER BY C9_PEDIDO,B1_DESC"

MemoWrite('C:\pasta\TOKR01_',cQuery)
...
While !EOF()
   ...
   Endif
    ...
    while !eof() .and. ccpedido = TMP->C9_PEDIDO                                                               
	  ...
	  nLin := nLin + 1 
	  @ nLin,001 PSAY "Valor Total do Peso Bfuto : " 
...
Aadd(aRegs,{c_Perg8,"06","Nota de Abastecimento :","","","mv_ch6" ,"C",01,0,0,"C","","mv_par06","Sim","Sim","Sim"                  ,"","","Nao"        ,"Nao"        ,"Nao"        ,"","","","","","","","","","","","","","","","","",""})
