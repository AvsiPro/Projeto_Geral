...
#DEFINE MAXITEMC   030                                                // Máxima de caracteres por linha de produtos/serviços  ALTERACAO GUSTAVO
...
local lVerPerg := .T.
//Toktake
Local lHabEnv		:=	GetMv("MV_XHABEMC")
...
PRIVATE OFONT14N   := TFontEx():New(oDanfe,"Times New Roman",13,13,.T.,.T.,.F.)// 12  
...
oDanfe:Say(006, 002, "RECEBEMOS DE "+NoChar(oEmitente:_xNome:Text,lConverte)+" OS PRODUTOS CONSTANTES DA NOTA FISCAL INDICADA AO LADO / "+NoChar(oDestino:_XNome:TEXT,lConverte), oFont07:oFont)
...
oDanfe:Say(007, 510, "NF-e/F.: "+xFilial("SF2"), oFont08N:oFont)
...
If SM0->M0_CODIGO=="10"
	oDanfe:Say(036, 510,"Filial "+Alltrim(SM0->M0_FILIAL),oFont07:oFont)
EndIf
...
oDanfe:Say(106,098, "Identificação do emitente",oFont12N:oFont)
nLinCalc	:=	128
...
oDanfe:Say(108,255, "DANFE",oFont18N:oFont)
oDanfe:Say(118,255, "DOCUMENTO AUXILIAR DA",oFont07:oFont)
oDanfe:Say(128,255, "NOTA FISCAL ELETRÔNICA",oFont07:oFont)
oDanfe:Say(138,255, "0-ENTRADA",oFont08:oFont)
oDanfe:Say(148,255, "1-SAÍDA"  ,oFont08:oFont)
oDanfe:Box(131,305,141,315)
oDanfe:Say(138,307, oIdent:_TpNf:Text,oFont08N:oFont)
oDanfe:Say(163,255,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N:oFont)
oDanfe:Say(173,255,"SÉRIE "+oIdent:_Serie:Text,oFont10N:oFont)
oDanfe:Say(183,255,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N:oFont)
...
If nfolha==1
	...
	Else
		oDanfe:SayBitmap(095,000,cLogo,095,096)
	EndIF
Endif
...
oDanfe:Say(148,355,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont12N:oFont)
oDanfe:Box(158,351,190,603)

If nFolha == 1
	oDanfe:Say(138,355,"CHAVE DE ACESSO DA NF-E",oFont12N:oFont)
	//nFontSize := 28
	//oDanfe:Code128C(125,370,SubStr(oNF:_InfNfe:_ID:Text,4), nFontSize )
	nFontSize := 25
	oDanfe:Code128C(125,380,SubStr(oNF:_InfNfe:_ID:Text,4), nFontSize )
EndIf
...
If Empty(cCodAutDPEC)
	If Empty(cChaveCont)
		oDanfe:Say(170,355,"Consulta de autenticidade no portal nacional da NF-e",oFont12:oFont)
		oDanfe:Say(180,355,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont12:oFont)
	Endif
Endif
...
If !Empty(cChaveCont) .And. Empty(cCodAutDPEC) .And. !(Val(SubStr(oNF:_INFNFE:_IDE:_SERIE:TEXT,1,3)) >= 900)
	...
	Else
		If !Empty(cChaveCont)
			nFontSize := 28
			oDanfe:Code128C(165,370,cChaveCont, nFontSize )
		EndIf
	EndIf
EndIf
...
oDanfe:Say(201,002,"NATUREZA DA OPERAÇÃO",oFont08N:oFont)
oDanfe:Say(211,002,oIdent:_NATOP:TEXT,oFont08:oFont)


If !Empty(cCodAutDPEC)
	oDanfe:Say(201,300,"NÚMERO DE REGISTRO DPEC",oFont08N:oFont)
Endif
...
If Empty(cCodAutDPEC) .And. (((Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"23") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1")
	oDanfe:Say(201,352,"PROTOCOLO DE AUTORIZAÇÃO DE USO",oFont08N:oFont)
Endif
If((oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"25")
	oDanfe:Say(201,300,"DADOS DA NF-E",oFont08N:oFont)
Endif
oDanfe:Say(211,352,IIF(!Empty(cCodAutDPEC),cCodAutDPEC+" "+AllTrim(IIF(!Empty(dDtReceb),ConvDate(DTOS(dDtReceb)),ConvDate(If(XmlChildEx(oNF:_InfNfe:_IDE,"_DHEMI") != NIL,oNF:_InfNfe:_IDE:_DHEMI:Text,oNF:_InfNfe:_IDE:_DEMI:Text))))+" "+AllTrim(cDtHrRecCab),IIF(!Empty(cCodAutSef) .And. ((Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"23") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1",cCodAutSef+" "+AllTrim(IIF(!Empty(dDtReceb),ConvDate(DTOS(dDtReceb)),ConvDate(If(XmlChildEx(oNF:_InfNfe:_IDE,"_DHEMI") != NIL,oNF:_InfNfe:_IDE:_DHEMI:Text,oNF:_InfNfe:_IDE:_DEMI:Text))))+" "+AllTrim(cDtHrRecCab),TransForm(cChaveCont,"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999"))),oFont08:oFont)
...
oDanfe:Say(225,002,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
oDanfe:Say(233,002,IIf(Type("oEmitente:_IE:TEXT")<>"U",oEmitente:_IE:TEXT,""),oFont08:oFont)
oDanfe:Say(225,205,"INSC.ESTADUAL DO SUBST.TRIB.",oFont08N:oFont)
oDanfe:Say(233,205,IIf(Type("oEmitente:_IEST:TEXT")<>"U",oEmitente:_IEST:TEXT,""),oFont08:oFont)
oDanfe:Say(225,405,"CNPJ",oFont08N:oFont)
oDanfe:Say(233,405,TransForm(oEmitente:_CNPJ:TEXT,IIf(Len(oEmitente:_CNPJ:TEXT)<>14,"@r 999.999.999-99","@r 99.999.999/9999-99")),oFont08:oFont)
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
oDanfe:Say(248,002,"DESTINATARIO/REMETENTE",oFont08N:oFont)
oDanfe:Box(250,000,270,450)
oDanfe:Say(258,002, "NOME/RAZÃO SOCIAL",oFont08N:oFont)
oDanfe:Say(268,002,NoChar(oDestino:_XNome:TEXT,lConverte),oFont08:oFont)
oDanfe:Box(250,280,270,500)
oDanfe:Say(258,283,"CNPJ/CPF",oFont08N:oFont)
oDanfe:Say(268,283,cAux,oFont08:oFont)

oDanfe:Box(270,000,290,500)
oDanfe:Box(270,000,290,260)
oDanfe:Say(277,002,"ENDEREÇO",oFont08N:oFont)
oDanfe:Say(287,002,aDest[01],oFont08:oFont)
oDanfe:Box(270,230,290,380)
oDanfe:Say(277,232,"BAIRRO/DISTRITO",oFont08N:oFont)
oDanfe:Say(287,232,aDest[02],oFont08:oFont)
oDanfe:Box(270,380,290,500)
oDanfe:Say(277,382,"CEP",oFont08N:oFont)
oDanfe:Say(287,382,aDest[03],oFont08:oFont)

oDanfe:Box(289,000,310,500)
oDanfe:Box(289,000,310,180)
oDanfe:Say(298,002,"MUNICIPIO",oFont08N:oFont)
oDanfe:Say(308,002,aDest[05],oFont08:oFont)
oDanfe:Box(289,150,310,256)
oDanfe:Say(298,152,"FONE/FAX",oFont08N:oFont)
oDanfe:Say(308,152,aDest[06],oFont08:oFont)
oDanfe:Box(289,255,310,341)
oDanfe:Say(298,257,"UF",oFont08N:oFont)
oDanfe:Say(308,257,aDest[07],oFont08:oFont)
oDanfe:Box(289,340,310,500)
oDanfe:Say(298,342,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
oDanfe:Say(308,342,aDest[08],oFont08:oFont)


oDanfe:Box(250,502,270,603)
oDanfe:Say(258,504,"DATA DE EMISSÃO",oFont08N:oFont)
oDanfe:Say(268,504,ConvDate(If(XmlChildEx(oIdent,"_DHEMI")	 != NIL,oIdent:_DHEmi:TEXT,oIdent:_DEmi:TEXT)),oFont08:oFont)
oDanfe:Box(270,502,290,603)
oDanfe:Say(277,504,"DATA ENTRADA/SAÍDA",oFont08N:oFont)
//oDanfe:Say(233,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont)
oDanfe:Box(289,502,310,603)
oDanfe:Say(298,503,"HORA ENTRADA/SAÍDA",oFont08N:oFont)
...
oDanfe:Say(316,002,"FATURA",oFont08N:oFont)
...
If Len(aFaturas) >0
	For nY := 1 To 9
		oDanfe:Say(326,nColuna,aAux[1][nY][1],oFont08:oFont)
		oDanfe:Say(334,nColuna,aAux[1][nY][2],oFont08:oFont)
		oDanfe:Say(342,nColuna,aAux[1][nY][3],oFont08:oFont)
		nColuna:= nColuna+67
	Next nY
Endif
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Calculo do imposto                                                      ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Say(358,002,"CALCULO DO IMPOSTO",oFont08N:oFont)
oDanfe:Box(360,000,383,121)
oDanfe:Say(369,002,"BASE DE CALCULO DO ICMS",oFont08N:oFont)
If cMVCODREG $ "3" 
	oDanfe:Say(379,002,aTotais[01],oFont08:oFont)
ElseIf lImpSimpN
	oDanfe:Say(379,002,aSimpNac[01],oFont08:oFont)	
Endif
oDanfe:Box(360,120,383,200)
oDanfe:Say(369,125,"VALOR DO ICMS",oFont08N:oFont)
If cMVCODREG $ "3" 
	oDanfe:Say(379,125,aTotais[02],oFont08:oFont)
ElseIf lImpSimpN
	oDanfe:Say(379,125,aSimpNac[02],oFont08:oFont)
Endif
oDanfe:Box(360,199,383,360)
oDanfe:Say(369,200,"BASE DE CALCULO DO ICMS SUBSTITUIÇÃO",oFont08N:oFont)
oDanfe:Say(379,202,aTotais[03],oFont08:oFont)
oDanfe:Box(360,360,383,490)
oDanfe:Say(369,363,"VALOR DO ICMS SUBSTITUIÇÃO",oFont08N:oFont)
oDanfe:Say(379,363,aTotais[04],oFont08:oFont)
oDanfe:Box(360,490,383,603)
oDanfe:Say(369,491,"VALOR TOTAL DOS PRODUTOS",oFont08N:oFont)
oDanfe:Say(379,491,aTotais[05],oFont08:oFont)


oDanfe:Box(383,000,406,110)
oDanfe:Say(392,002,"VALOR DO FRETE",oFont08N:oFont)
oDanfe:Say(402,002,aTotais[06],oFont08:oFont)
oDanfe:Box(383,100,406,190)
oDanfe:Say(392,102,"VALOR DO SEGURO",oFont08N:oFont)
oDanfe:Say(402,102,aTotais[07],oFont08:oFont)
oDanfe:Box(383,190,406,290)
oDanfe:Say(392,194,"DESCONTO",oFont08N:oFont)
oDanfe:Say(402,194,aTotais[08],oFont08:oFont)
oDanfe:Box(383,290,406,415)
oDanfe:Say(392,295,"OUTRAS DESPESAS ACESSÓRIAS",oFont08N:oFont)
oDanfe:Say(402,295,aTotais[09],oFont08:oFont)
oDanfe:Box(383,414,406,500)
oDanfe:Say(392,420,"VALOR DO IPI",oFont08N:oFont)
oDanfe:Say(402,420,aTotais[10],oFont08:oFont)
oDanfe:Box(383,500,406,603)
oDanfe:Say(392,506,"VALOR TOTAL DA NOTA",oFont08N:oFont)
oDanfe:Say(402,506,aTotais[11],oFont08:oFont)
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Transportador/Volumes transportados                                     ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Say(414,002,"TRANSPORTADOR/VOLUMES TRANSPORTADOS",oFont08N:oFont)
oDanfe:Box(416,000,439,603)
oDanfe:Say(425,002,"RAZÃO SOCIAL",oFont08N:oFont)
oDanfe:Say(435,002,aTransp[01],oFont08:oFont)
oDanfe:Box(416,245,439,315)
oDanfe:Say(425,247,"FRETE POR CONTA",oFont08N:oFont)
If cModFrete =="0"
	oDanfe:Say(435,247,"0-EMITENTE",oFont08:oFont)
ElseIf cModFrete =="1"
	oDanfe:Say(435,247,"1-DEST/REM",oFont08:oFont)
ElseIf cModFrete =="2"
	oDanfe:Say(435,247,"2-TERCEIROS",oFont08:oFont)
ElseIf cModFrete =="3"
	oDanfe:Say(382,247,"3-REMETENTE",oFont08:oFont)
ElseIf cModFrete =="4"
	oDanfe:Say(382,247,"4-DESTINATARIO",oFont08:oFont)
ElseIf cModFrete =="9"
	oDanfe:Say(435,247,"9-SEM FRETE",oFont08:oFont)
Else
	oDanfe:Say(435,247,"",oFont08:oFont)
Endif
//oDanfe:Say(382,102,"0-EMITENTE/1-DESTINATARIO       [" + aTransp[02] + "]",oFont08:oFont)
oDanfe:Box(416,315,439,370)
oDanfe:Say(425,317,"CÓDIGO ANTT",oFont08N:oFont)
oDanfe:Say(435,319,aTransp[03],oFont08:oFont)
oDanfe:Box(416,370,439,490)
oDanfe:Say(425,375,"PLACA DO VEÍCULO",oFont08N:oFont)
oDanfe:Say(435,375,aTransp[04],oFont08:oFont)
oDanfe:Box(416,450,439,510)
oDanfe:Say(425,452,"UF",oFont08N:oFont)
oDanfe:Say(435,452,aTransp[05],oFont08:oFont)
oDanfe:Box(416,510,439,603)
oDanfe:Say(425,512,"CNPJ/CPF",oFont08N:oFont)
oDanfe:Say(435,512,aTransp[06],oFont08:oFont)

oDanfe:Box(438,000,462,603)
oDanfe:Box(438,000,462,241)
oDanfe:Say(446,002,"ENDEREÇO",oFont08N:oFont)
oDanfe:Say(457,002,aTransp[07],oFont08:oFont)
oDanfe:Box(438,240,462,341)
oDanfe:Say(446,242,"MUNICIPIO",oFont08N:oFont)
oDanfe:Say(457,242,aTransp[08],oFont08:oFont)
oDanfe:Box(438,340,462,440)
oDanfe:Say(446,342,"UF",oFont08N:oFont)
oDanfe:Say(457,342,aTransp[09],oFont08:oFont)
oDanfe:Box(438,440,462,603)
oDanfe:Say(446,442,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
oDanfe:Say(457,442,aTransp[10],oFont08:oFont)


oDanfe:Box(461,000,485,603)
oDanfe:Box(461,000,485,050)
oDanfe:Say(471,002,"QUANTIDADE",oFont08N:oFont)
oDanfe:Say(482,002,aTransp[11],oFont08:oFont)
oDanfe:Box(461,100,485,200)
oDanfe:Say(471,102,"ESPECIE",oFont08N:oFont)
oDanfe:Say(482,102,Iif(!Empty(aTransp[12]),aTransp[12],Iif(Len(aEspVol)>0,aEspVol[1][1],"")),oFont08:oFont)
//oDanfe:Say(428,102,aEspVol[1][1],oFont08:oFont)
oDanfe:Box(461,200,485,301)
oDanfe:Say(471,202,"MARCA",oFont08N:oFont)
oDanfe:Say(482,202,aTransp[13],oFont08:oFont)
oDanfe:Box(461,300,485,400)
oDanfe:Say(471,302,"NUMERAÇÃO",oFont08N:oFont)
oDanfe:Say(482,302,aTransp[14],oFont08:oFont)
oDanfe:Box(461,400,485,501)
oDanfe:Say(471,402,"PESO BRUTO",oFont08N:oFont)
oDanfe:Say(482,402,Iif(!Empty(aTransp[15]),aTransp[15],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][3])>0,Transform(Val(aEspVol[1][3]),"@E 999999.9999"),"")),oFont08:oFont)
//oDanfe:Say(428,402,Iif (!Empty(aEspVol[1][3]),Transform(val(aEspVol[1][3]),"@E 999999.9999"),""),oFont08:oFont)
oDanfe:Box(461,500,485,603)
oDanfe:Say(471,502,"PESO LIQUIDO",oFont08N:oFont)
oDanfe:Say(482,502,Iif(!Empty(aTransp[16]),aTransp[16],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][2])>0,Transform(Val(aEspVol[1][2]),"@E 999999.9999"),"")),oFont08:oFont)
...
oDanfe:Say(493,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N:oFont)
oDanfe:Box(495,000,678,603)
nAuxH := 0
oDanfe:Box(495,000,678,040)
oDanfe:Say(503,002,"COD. PROD",oFont08N:oFont)
//nAuxH += aTamCol[1]
oDanfe:Box(495,038,678,175)
oDanfe:Say(503,040,"DESCRIÇÃO DO PROD./SERV.",oFont08N:oFont)
//nAuxH += aTamCol[2]
oDanfe:Box(495,175,678,210)
oDanfe:Say(503,177,"NCM/SH",oFont08N:oFont)
//nAuxH += aTamCol[3]
oDanfe:Box(495,210,678,230)
oDanfe:Say(503,212,"CST",oFont08N:oFont)
//nAuxH += aTamCol[4]
oDanfe:Box(495,230,678,250)
oDanfe:Say(503,232,"CFOP",oFont08N:oFont)
//nAuxH += aTamCol[5]
oDanfe:Box(495,250,678,270)
oDanfe:Say(503,252,"UN",oFont08N:oFont)
//nAuxH += aTamCol[6]
oDanfe:Box(495,270,678,309)
oDanfe:Say(503,272,"QUANT.",oFont08N:oFont)
//nAuxH += aTamCol[7]
oDanfe:Box(495,309,678,366)
oDanfe:Say(503,312,"V.UNITARIO",oFont08N:oFont)
//nAuxH += aTamCol[8]
oDanfe:Box(495,366,678,420)
oDanfe:Say(503,372,"V.TOTAL",oFont08N:oFont)
//nAuxH += aTamCol[9]
oDanfe:Box(495,420,678,480)
oDanfe:Say(503,422,"BC.ICMS",oFont08N:oFont)
//nAuxH += aTamCol[10]
oDanfe:Box(495,480,678,525)
oDanfe:Say(503,482,"V.ICMS",oFont08N:oFont)
//nAuxH += aTamCol[11]
oDanfe:Box(495,525,678,550)
oDanfe:Say(503,527,"V.IPI",oFont08N:oFont)
//nAuxH += aTamCol[12]
oDanfe:Box(495,550,678,578)
oDanfe:Say(503,552,"A.ICMS",oFont08N:oFont)
//nAuxH += aTamCol[13]
oDanfe:Box(495,578,678,603)
oDanfe:Say(503,582,"A.IPI",oFont08N:oFont)
	...
	If lflag
		If nL > nMaxItemP2
			...
			If(((Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"2") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1")
				oDanfe:Say(201,302,"PROTOCOLO DE AUTORIZAÇÃO DE USO",oFont08N:oFont)
			Endif
			If((oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"25")
				oDanfe:Say(201,300,"DADOS DA NF-E",oFont08N:oFont)
			Endif
			oDanfe:Say(211,302,IIF(!Empty(cCodAutDPEC),cCodAutDPEC+" "+AllTrim(ConvDate(If(XmlChildEx(oNF:_InfNfe:_IDE,"_DHEMI")!= Nil,oNF:_InfNfe:_IDE:_DHEMI:Text,oNF:_InfNfe:_IDE:_DEMI:Text)))+" "+AllTrim(cDtHrRecCab),IIF(!Empty(cCodAutSef) .And. ((Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"23") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1",cCodAutSef+" "+AllTrim(ConvDate(If(XmlChildEx(oNF:_InfNfe:_IDE,"_DHEMI")!= Nil,oNF:_InfNfe:_IDE:_DHEMI:Text,oNF:_InfNfe:_IDE:_DEMI:Text)))+" "+AllTrim(cDtHrRecCab),TransForm(cChaveCont,"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999"))),oFont08:oFont)
			...
			oDanfe:Say(245,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N:oFont)
			oDanfe:Box(248,000,nColLim,603)

			nAuxH := 0
			oDanfe:Box(248,000,nColLim,040)
			oDanfe:Say(255,002,"COD. PROD",oFont08N:oFont)
//			nAuxH += aTamCol[1]
			oDanfe:Box(248,038,nColLim,175)
			oDanfe:Say(255,042,"DESCRIÇÃO DO PROD./SERV.",oFont08N:oFont)
//			nAuxH += aTamCol[2]
			oDanfe:Box(248,175,nColLim,210)
			oDanfe:Say(255,177,"NCM/SH",oFont08N:oFont)
//			nAuxH += aTamCol[3]
			oDanfe:Box(248,210,nColLim,230)
			oDanfe:Say(255,212,"CST",oFont08N:oFont)
//			nAuxH += aTamCol[4]
			oDanfe:Box(248,230,nColLim,250)
			oDanfe:Say(255,232,"CFOP",oFont08N:oFont)
//			nAuxH += aTamCol[5]
			oDanfe:Box(248,250,nColLim,270)
			oDanfe:Say(255,252,"UN",oFont08N:oFont)
//			nAuxH += aTamCol[6]
			oDanfe:Box(248,270,nColLim,309)
			oDanfe:Say(255,272,"QUANT.",oFont08N:oFont)
//			nAuxH += aTamCol[7]
			oDanfe:Box(248,309,nColLim,366)
			oDanfe:Say(255,312,"V.UNITARIO",oFont08N:oFont)
//			nAuxH += aTamCol[8]
			oDanfe:Box(248,366,nColLim,420)
			oDanfe:Say(255,372,"V.TOTAL",oFont08N:oFont)
//			nAuxH += aTamCol[9]
			oDanfe:Box(248,420,nColLim,480)
			oDanfe:Say(255,422,"BC.ICMS",oFont08N:oFont)
//			nAuxH += aTamCol[10]
			oDanfe:Box(248,480,nColLim,525)
			oDanfe:Say(255,482,"V.ICMS",oFont08N:oFont)
//			nAuxH += aTamCol[11]
			oDanfe:Box(248,525,nColLim,550)
			oDanfe:Say(255,527,"V.IPI",oFont08N:oFont)
//			nAuxH += aTamCol[12]
			oDanfe:Box(248,550,nColLim,578)
			oDanfe:Say(255,552,"A.ICMS",oFont08N:oFont)
//			nAuxH += aTamCol[13]
			oDanfe:Box(248,578,nColLim,603)
			oDanfe:Say(255,582,"A.IPI",oFont08N:oFont)
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		oDanfe:Say(244,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N:oFont)
		oDanfe:Box(246,000,nColLim+10,603)
		
		nAuxH := 0
		oDanfe:Box(243,000,nColLim,040)
		oDanfe:Say(255,002,"COD. PROD",oFont08N:oFont)
//		nAuxH += aTamCol[1]
		oDanfe:Box(243,040,nColLim,155)
		oDanfe:Say(255,042,"DESCRIÇÃO DO PROD./SERV.",oFont08N:oFont)
//		nAuxH += aTamCol[2]
		oDanfe:Box(243,155,nColLim,190)
		oDanfe:Say(255,157,"NCM/SH",oFont08N:oFont)
//		nAuxH += aTamCol[3]
		oDanfe:Box(243,190,nColLim,210)
		oDanfe:Say(255,192,"CST",oFont08N:oFont)
//		nAuxH += aTamCol[4]
		oDanfe:Box(243,210,nColLim,230)
		oDanfe:Say(255,212,"CFOP",oFont08N:oFont)
//		nAuxH += aTamCol[5]
		oDanfe:Box(243,230,nColLim,250)
		oDanfe:Say(255,232,"UN",oFont08N:oFont)
//		nAuxH += aTamCol[6]
		oDanfe:Box(243,250,nColLim,289)
		oDanfe:Say(255,252,"QUANT.",oFont08N:oFont)
//		nAuxH += aTamCol[7]
		oDanfe:Box(243,289,nColLim,346)
		oDanfe:Say(255,292,"V.UNITARIO",oFont08N:oFont)
//		nAuxH += aTamCol[8]
		oDanfe:Box(243,346,nColLim,400)
		oDanfe:Say(255,348,"V.TOTAL",oFont08N:oFont)
//		nAuxH += aTamCol[9]
		oDanfe:Box(243,400,nColLim,465)
		oDanfe:Say(255,402,"BC.ICMS",oFont08N:oFont)
//		nAuxH += aTamCol[10]
		oDanfe:Box(243,465,nColLim,515)
		oDanfe:Say(255,467,"V.ICMS",oFont08N:oFont)
//		nAuxH += aTamCol[11]
		oDanfe:Box(243,515,nColLim,550)
		oDanfe:Say(255,517,"V.IPI",oFont08N:oFont)
//		nAuxH += aTamCol[12]
...
//		nAuxH += aTamCol[1]
		oDanfe:Say(nLinha,040,aAux[1][2][nY],oFont08:oFont) // DESCRICAO DO PRODUTO
//		nAuxH += aTamCol[2]
		oDanfe:Say(nLinha,177,aAux[1][3][nY],oFont08:oFont) // NCM
///		nAuxH += aTamCol[3]
		oDanfe:Say(nLinha,212,aAux[1][4][nY],oFont08:oFont) // CST
//		nAuxH += aTamCol[4]
		oDanfe:Say(nLinha,232,aAux[1][5][nY],oFont08:oFont) // CFOP
//		nAuxH += aTamCol[5]
		oDanfe:Say(nLinha,252,aAux[1][6][nY],oFont08:oFont) // UN
//		nAuxH += aTamCol[6]
...
//			nAuxH2 := nAuxH + ((aTamCol[7] - 2) - RetTamTex(aAux[1][7][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha,280,aAux[1][7][nY],oFont08:oFont,45, 10, , 1,  ) // QUANT
//		nAuxH += aTamCol[7]
		If Empty(aAux[1][6][nY]) // UN
...
//			nAuxH2 := nAuxH + ((aTamCol[8] - 2) - RetTamTex(aAux[1][8][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha,330,aAux[1][8][nY],oFont08:oFont,52, 10, , 1,  ) // V UNITARIO
//		nAuxH += aTamCol[8]
		If Empty(aAux[1][6][nY]) // UN
...
//			nAuxH2 := nAuxH + ((aTamCol[9] - 2) - RetTamTex(aAux[1][9][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha,382,aAux[1][9][nY],oFont08:oFont,50, 10, , 1,  ) // V. TOTAL
//		nAuxH += aTamCol[9]
		If Empty(aAux[1][6][nY]) // UN
...
//			nAuxH2 := nAuxH + ((aTamCol[10] - 2) - RetTamTex(aAux[1][10][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha,442,aAux[1][10][nY],oFont08:oFont,50, 10, , 1,  ) // BC. ICMS
//		nAuxH += aTamCol[10]
		If Empty(aAux[1][6][nY]) // UN
...
//			nAuxH2 := nAuxH + ((aTamCol[11] - 2) - RetTamTex(aAux[1][11][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha,492,aAux[1][11][nY],oFont08:oFont,45, 10, , 1,  ) // V. ICMS
//		nAuxH += aTamCol[11]
		If Empty(aAux[1][6][nY]) // UN
...
//			nAuxH2 := nAuxH + ((aTamCol[12] - 2) - RetTamTex(aAux[1][12][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha,533,aAux[1][12][nY],oFont08:oFont,45, 10, , 1,  ) // V.IPI
//		nAuxH += aTamCol[12]
//		nAuxH2 := nAuxH + ((aTamCol[13] - 2) - RetTamTex(aAux[1][13][nY], oFont08:oFont, oDanfe)) + 2
		oDanfe:Say(nLinha,555,aAux[1][13][nY],oFont08:oFont,30, 10, , 1,  ) // A.ICMS
//		nAuxH += aTamCol[13]
//		nAuxH2 := nAuxH + ((aTamCol[14] - 2) - RetTamTex(aAux[1][14][nY], oFont08:oFont, oDanfe)) + 2
		oDanfe:Say(nLinha,580,aAux[1][14][nY],oFont08:oFont,36, 10, , 1,  ) // A.IPI
	EndIf
...
If lMensagens
	...
	oDanfe:StartPage()
	nLinha    := 275 //180
	oDanfe:Say(245,000,"DADOS ADICIONAIS",oFont08N:oFont)
	oDanfe:Box(248,000,865,351)
	oDanfe:Say(265,002,"INFORMAÇÕES COMPLEMENTARES",oFont08N:oFont)
	oDanfe:Box(267,350,865,603)
	oDanfe:Say(265,352,"RESERVADO AO FISCO",oFont08N:oFont)
	...
	oDanfe:Say(140,307, oIdent:_TpNf:Text,oFont08N:oFont)
	oDanfe:Say(157,255,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N:oFont)
	oDanfe:Say(167,255,"SÉRIE "+oIdent:_Serie:Text,oFont10N:oFont)
	oDanfe:Say(177,255,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N:oFont)
	
	oDanfe:Box(095,350,190,603)
	oDanfe:Box(095,350,135,603)
	oDanfe:Box(135,350,157,603)
	oDanfe:Box(158,350,190,603)
	oDanfe:Say(153,355,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont12N:oFont)
	
	oDanfe:Say(143,355,"CHAVE DE ACESSO DA NF-E",oFont12N:oFont)
	nFontSize := 28
	...
	oDanfe:Say(204,002,"NATUREZA DA OPERAÇÃO",oFont08N:oFont)
	oDanfe:Say(214,002,oIdent:_NATOP:TEXT,oFont08:oFont)
	If(!Empty(cCodAutDPEC))
		oDanfe:Say(204,300,"NÚMERO DE REGISTRO DPEC",oFont08N:oFont)
	Endif
	If(((Val(SubStr(oNF:_INFNFE:_IDE:_SERIE:TEXT,1,3)) >= 900).And.(oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"2") .Or. (oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"1")
		oDanfe:Say(204,302,"PROTOCOLO DE AUTORIZAÇÃO DE USO",oFont08N:oFont)
	Endif
	If((oNFe:_NFE:_INFNFE:_IDE:_TPEMIS:TEXT)$"25")
		oDanfe:Say(204,300,"DADOS DA NF-E",oFont08N:oFont)
	Endif
	...
	oDanfe:Say(188,002,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
	oDanfe:Say(238,002,IIf(Type("oEmitente:_IE:TEXT")<>"U",oEmitente:_IE:TEXT,""),oFont08:oFont)
	oDanfe:Say(188,205,"INSC.ESTADUAL DO SUBST.TRIB.",oFont08N:oFont)
	oDanfe:Say(238,205,IIf(Type("oEmitente:_IEST:TEXT")<>"U",oEmitente:_IEST:TEXT,""),oFont08:oFont)
	oDanfe:Say(188,405,"CNPJ",oFont08N:oFont)
	oDanfe:Say(238,405,TransForm(oEmitente:_CNPJ:TEXT,IIf(Len(oEmitente:_CNPJ:TEXT)<>14,"@r 999.999.999-99","@r 99.999.999/9999-99")),oFont08:oFont)
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Box(000,000,010,501)
oDanfe:Say(006, 002, "RECEBEMOS DE "+NoChar(oEmitente:_xNome:Text,lConverte)+" - "+Alltrim(SM0->M0_FILIAL)+" OS PRODUTOS CONSTANTES DA NOTA FISCAL INDICADA AO LADO - "+NoChar(oDestino:_XNome:Text,lConverte), oFont07:oFont)
oDanfe:Box(009,000,037,101)
oDanfe:Say(017, 002, "DATA DE RECEBIMENTO", oFont07N:oFont)
oDanfe:Box(009,100,037,500)
oDanfe:Say(017, 102, "IDENTIFICAÇÃO E ASSINATURA DO RECEBEDOR", oFont07N:oFont)
