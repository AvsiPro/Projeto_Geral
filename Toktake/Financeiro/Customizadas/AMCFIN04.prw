...
±±º PROGRAMA     º AMCFIN04  º AUTOR ºAlexandre Venâncio  º DATA º01/08/2016   º±±
...
*/
user function AMCFIN04(lAutomat)
...
//oPrint 	:= FWMSPrinter():New(strzero(VAL(MV_PAR02),9)+SE1->E1_CLIENTE+SE1->E1_LOJA+".rel",  IMP_PDF, lAdjustToLegacy, "C:\Temp\", lDisableSetup,,,,.F.,,,.F.)
oPrint 	:= FWMSPrinter():New("Boleto_"+strzero(VAL(MV_PAR02),9)+SE1->E1_CLIENTE+SE1->E1_LOJA+".rel",  IMP_PDF, lAdjustToLegacy, "\", lDisableSetup,,,,.F.,,,.T.)
...
//oPrint:cPathPDF := "\_AMC\Nota_Debito\"+cFilAnt+"\"
...
±±ºPrograma  ³AMCFIN04  ºAutor  ³Microsiga           º Data ³  09/13/16   º±±
