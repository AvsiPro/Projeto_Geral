...
ฑฑบPrograma  ณTTFINC11  บAutor  ณRonaldo G. de Jesus บ Data ณ  07/06/17   บฑฑ
...
User Function TTFINC11(cCodEmp,cCodFil)
...
Local aArquivos := {}           
Local cDestino	:=	"avenanc@yahoo.com.br"	//"avenanc@yahoo.com.br" 
...
Aadd(aArquivos,{"\system\logo_toktake.png",'Content-ID: <ID_logo_toktake.png>'})
...
While !EOF()
	...
	cDestino := Alltrim(TRB->A1_EMAIL)+";fin.tt@toktake.com.br"
	//cDestino	:=	"avenanc@yahoo.com.br"//;fin.tt@toktake.com.br;vzukurov@toktake.com.br" 
...
If len(aAvisFi) > 0 
	...
	//cDestino := 'vzukurov@toktake.com.br;avenanc@yahoo.com.br;fin.amc@toktake.com.br'
	//cDestino	:=	"avenanc@yahoo.com.br"//;fin.amc@toktake.com.br;vzukurov@toktake.com.br" 
...
If len(aAvisFi) > 0 
	cBody := AvisFin(cSubject)
	//cDestino := 'vzukurov@toktake.com.br;avenanc@yahoo.com.br;fin.tt@toktake.com.br'
	//cDestino	:=	"avenanc@yahoo.com.br"//;fin.tt@toktake.com.br;vzukurov@toktake.com.br" 
	U_TTMAILN(cRemete,cDestFin,cSubject+" "+cvaltochar(ddatabase),cBody,{},.T.)
EndIf
...
cHtml += "  </tr>"
cHtml += "  <tr>"
cHtml += "	<td><img src='cid:logo_toktake.png'></td>"
cHtml += "  </tr>"
cHtml += "</table>"  
...
cHtml += "  </tr><br><br><br>"
cHtml += "  <tr>"
cHtml += "    <td><p><strong>"+Posicione("SM0",1,"01"+SUBSTR(aTitCli[01,10],1,2),"M0_NOMECOM")+"</strong><br />"
cHtml += "      Departamento Financeiro<br />"
cHtml += "      "+Posicione("SM0",1,"01"+SUBSTR(aTitCli[01,10],1,2),"M0_ENDENT")+" "+Posicione("SM0",1,"01"+SUBSTR(aTitCli[01,10],1,2),"M0_CIDENT")+" - "+Posicione("SM0",1,"01"+SUBSTR(aTitCli[01,10],1,2),"M0_ESTENT")+"<br />"
...
User Function TTFINC99

Local cParaF := GetMV("MV_XMAILCB")
Local aRet	:=	{}
Local aPerg	:=	{}

aAdd(aPerg ,{1,"Emails"	,cParaF,"@!",".T.","",".T.",160,.F.})

If !ParamBox(aPerg ,"Informe Emails Financeiro",@aRet)
	Return                                     
EndIF                                          

PUTMV("MV_XMAILCB",aRet[1])
