...
±±ºPrograma  ³TTGENC01  ºAutor  ³Alexandre Venancio  º Data ³  28/02/12   º±±
...
User Function TTGENC01(xFil,Modulo,TipoMov,Prefixo,Docto,Serie,UserMov,DiaMov,HoraMov,Valor,Obs,cCli,cLoja,cTabela)

Local aArea	:= 	GetArea()
//dbSelectArea("SZL")
	//dbSetOrder(1)      
If substr(cEmpAnt,1,2) $ "01/02"
	Reclock("SZL",.T.)   
	SZL->ZL_FILIAL	:= xFil
