...
If nTipo <> 1
	...
	If lExistNFe
		...
		//venancio
		asaveb := GetArea()
		If ApMsgNoYes("Deseja imprimir as etiquetas","Boleto")==.T.
			U_ROBEST04(.T.)   
		EndIf
...
//venancio
	If nFaturas > 0
		...
		For nX := 1 to nFaturas
			oDanfe:Box(265+nAjustaFat,nCol1,296+nAjustaFat,nCol2)
			nCol1 := nCol2
			nCol2 += 52
		Next nX
		/*
		oDanfe:Box(265+nAjustaFat,000,296+nAjustaFat,052)
		oDanfe:Box(265+nAjustaFat,052,296+nAjustaFat,104)
		oDanfe:Box(265+nAjustaFat,104,296+nAjustaFat,156)
		oDanfe:Box(265+nAjustaFat,156,296+nAjustaFat,208)
		oDanfe:Box(265+nAjustaFat,208,296+nAjustaFat,260)
		oDanfe:Box(265+nAjustaFat,260,296+nAjustaFat,312)
		oDanfe:Box(265+nAjustaFat,312,296+nAjustaFat,364)
		oDanfe:Box(265+nAjustaFat,364,296+nAjustaFat,416)
		oDanfe:Box(265+nAjustaFat,416,296+nAjustaFat,468)
		//venancio
		oDanfe:Box(265+nAjustaFat,468,296+nAjustaFat,520)
		oDanfe:Box(265+nAjustaFat,520,296+nAjustaFat,572)
		oDanfe:Box(265+nAjustaFat,572,296+nAjustaFat,603)
		*/
	EndIf
