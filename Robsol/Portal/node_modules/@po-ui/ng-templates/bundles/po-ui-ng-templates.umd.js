(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@po-ui/ng-components'), require('@angular/router'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@po-ui/ng-templates', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@po-ui/ng-components', '@angular/router', '@angular/common/http', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['po-ui'] = global['po-ui'] || {}, global['po-ui']['ng-templates'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.i2, global.ng.router, global.ng.common.http, global.rxjs, global.rxjs.operators));
}(this, (function (exports, i0, common, forms, i2, router, i1, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function getShortBrowserLanguage() {
        var language = (getBrowserLanguage() || i2.poLocaleDefault).toLowerCase().substring(0, 2);
        if (!i2.poLocales.includes(language)) {
            return i2.poLocaleDefault;
        }
        return language;
    }
    ...
    function mapObjectByProperties(object, properties) {
        ...
        var getSelectedProperties = function (selectedProperties, property) {
            var _a;
            return (Object.assign(Object.assign({}, selectedProperties), (_a = {}, _a[property] = object[property], _a)));
        };
     ...
     */
    exports.PoModalPasswordRecoveryType = void 0;
    ...
    })(exports.PoModalPasswordRecoveryType || (exports.PoModalPasswordRecoveryType = {}));
    ...
    var PoModalPasswordRecoveryTypeDefault = exports.PoModalPasswordRecoveryType.Email;
    /**
     * @description
     *
    ...
    var PoModalPasswordRecoveryBaseComponent = /** @class */ (function () {
        function PoModalPasswordRecoveryBaseComponent(languageService) {
            /**
             * @optional
             *
             * @description
             ...
             */
            this.codeSubmit = new i0.EventEmitter();
            /**
             * @optional
             *
             * @description
            ...
            this.literals = poModalPasswordRecoveryLiterals[i2.poLocaleDefault];
        ...
        Object.defineProperty(PoModalPasswordRecoveryBaseComponent.prototype, "type", {
             ...
             */
            set: function (value) {
                this._type = Object.values(exports.PoModalPasswordRecoveryType).includes(value)
                    ? value
    ...
    PoModalPasswordRecoveryBaseComponent.ctorParameters = function () { return [
        { type: i2.PoLanguageService }
    ]; };
    PoModalPasswordRecoveryBaseComponent.propDecorators = {
        codeError: [{ type: i0.Input, args: ['p-code-error',] }],
        urlRecovery: [{ type: i0.Input, args: ['p-url-recovery',] }],
        codeSubmit: [{ type: i0.Output, args: ['p-code-submit',] }],
        submit: [{ type: i0.Output, args: ['p-submit',] }],
        contactEmail: [{ type: i0.Input, args: ['p-contact-email',] }],
        phoneMask: [{ type: i0.Input, args: ['p-phone-mask',] }],
     ...
     */
    exports.PoModalPasswordRecoveryModalContent = void 0;
    ...
    })(exports.PoModalPasswordRecoveryModalContent || (exports.PoModalPasswordRecoveryModalContent = {}));
    ...
    var PoModalPasswordRecoveryComponent = /** @class */ (function (_super) {
        ...
        function PoModalPasswordRecoveryComponent(router, poI18nPipe, poModalPasswordRecoveryService, poLanguageService) {
            ...
            _this.chosenTypeFormOption = exports.PoModalPasswordRecoveryType.Email;
            ...
            _this.modalType = exports.PoModalPasswordRecoveryModalContent.Email;
            ...
            _this.typeFormOptions = [
                { label: 'e-mail', value: exports.PoModalPasswordRecoveryType.Email },
                { label: 'SMS', value: exports.PoModalPasswordRecoveryType.SMS }
            ];
            return _this;
        }
        ...
        PoModalPasswordRecoveryComponent.prototype.formModelChangesCheck = function (form) {
            ...
            if (this.modalType === exports.PoModalPasswordRecoveryModalContent.SMSCode) {
        ...
        PoModalPasswordRecoveryComponent.prototype.openConfirmation = function () {
            ...
            this.modalType = exports.PoModalPasswordRecoveryModalContent.Confirmation;
        ...
        PoModalPasswordRecoveryComponent.prototype.openSmsCode = function () {
            ...
            this.modalType = exports.PoModalPasswordRecoveryModalContent.SMSCode;
        ...
        PoModalPasswordRecoveryComponent.prototype.cancelAction = function () {
            ...
            this.chosenTypeFormOption = exports.PoModalPasswordRecoveryType.Email;
            this.modalType = exports.PoModalPasswordRecoveryModalContent.Email;
            this.type = this.modalPasswordRecoveryTypeAll ? exports.PoModalPasswordRecoveryType.All : this.type;
            this.recoveryModalElement.close();
        };
        PoModalPasswordRecoveryComponent.prototype.checkFormType = function (type) {
            return type !== exports.PoModalPasswordRecoveryType.All ? type : exports.PoModalPasswordRecoveryType.Email;
        };
        ...
        PoModalPasswordRecoveryComponent.prototype.getEmitValue = function (type) {
            return type === exports.PoModalPasswordRecoveryType.SMS ? this.phone : this.email;
        };
        ...
        PoModalPasswordRecoveryComponent.prototype.pipeModalPhrases = function () {
            if (this.type === exports.PoModalPasswordRecoveryType.SMS) {
        ...
        PoModalPasswordRecoveryComponent.prototype.setEmailModalPhrasesAndActions = function () {
            ...
            this.pipeModalPhrases();
            this.modalPasswordRecoveryTypeAll = this.type === exports.PoModalPasswordRecoveryType.All;
        ...
        PoModalPasswordRecoveryComponent.prototype.submitActionRequest = function (data, modalType) {
            var _this = this;
            var params = modalType === exports.PoModalPasswordRecoveryType.SMS ? { type: 'sms' } : undefined;
            this.passwordRecoverySubscription = this.poModalPasswordRecoveryService
                .post(this.urlRecovery, data, params)
                .subscribe(function (response) {
                if ((modalType === exports.PoModalPasswordRecoveryType.Email || modalType === exports.PoModalPasswordRecoveryType.All) &&
                    response.status === 204) {
                    _this.openConfirmation();
                }
                else if (modalType === exports.PoModalPasswordRecoveryType.SMS && response.status === 200) {
    ...
    PoModalPasswordRecoveryComponent.propDecorators = {
        emailForm: [{ type: i0.ViewChild, args: ['emailForm',] }],
        recoveryModalElement: [{ type: i0.ViewChild, args: ['recoveryModal', { static: true },] }],
        smsCodeForm: [{ type: i0.ViewChild, args: ['smsCodeForm',] }]
    };
    ...
    PoModalPasswordRecoveryModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [common.CommonModule, forms.FormsModule, i2.PoFieldModule, i2.PoModalModule],
                    ...
                    providers: [i2.PoI18nPipe, PoModalPasswordRecoveryService]
                },] }
    ];
    ...
    var PoPageBackgroundComponent = /** @class */ (function () {
        function PoPageBackgroundComponent(poLanguageService) {
             ...
             */
            this.selectedLanguage = new i0.EventEmitter();
            this._showSelectLanguage = false;
        }
        Object.defineProperty(PoPageBackgroundComponent.prototype, "languagesList", {
            get: function () {
                var _a;
                if ((_a = this._languagesList) === null || _a === void 0 ? void 0 : _a.length) {
                    return this._languagesList;
                }
                return i2.poLanguageDefault;
            },
        ...
        Object.defineProperty(PoPageBackgroundComponent.prototype, "selectLanguageOptions", {
            get: function () {
        ...
        PoPageBackgroundComponent.prototype.setLanguageOptions = function () {
            this._selectLanguageOptions = this.languagesList.map(function (language) { return ({
    ...
    PoPageBackgroundComponent.ctorParameters = function () { return [
        { type: i2.PoLanguageService }
    ]; };
    PoPageBackgroundComponent.propDecorators = {
        background: [{ type: i0.Input, args: ['p-background',] }],
        initialSelectLanguage: [{ type: i0.Input, args: ['p-initial-language',] }],
        hideLogo: [{ type: i0.Input, args: ['p-hide-logo',] }],
        highlightInfo: [{ type: i0.Input, args: ['p-highlight-info',] }],
        selectedLanguage: [{ type: i0.Output, args: ['p-selected-language',] }],
        languagesList: [{ type: i0.Input, args: ['p-languages',] }],
        logo: [{ type: i0.Input, args: ['p-logo',] }],
        secondaryLogo: [{ type: i0.Input, args: ['p-secondary-logo',] }],
        showSelectLanguage: [{ type: i0.Input, args: ['p-show-select-language',] }]
    };
    ...
    PoPageBackgroundModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [common.CommonModule, forms.FormsModule, router.RouterModule, i2.PoDividerModule, i2.PoFieldModule],
     ...
     */
    exports.PoPageBlockedUserReason = void 0;
    ...
    })(exports.PoPageBlockedUserReason || (exports.PoPageBlockedUserReason = {}));

    var PoPageBlockedUserReasonDefault = exports.PoPageBlockedUserReason.None;
    ...
    var PoPageBlockedUserBaseComponent = /** @class */ (function () {
        function PoPageBlockedUserBaseComponent() {
            ...
            this._reason = exports.PoPageBlockedUserReason.None;
            this._urlBack = '/';
        }
        Object.defineProperty(PoPageBlockedUserBaseComponent.prototype, "params", {
            ...
            set: function (value) {
                if (value instanceof Object) {
                    ...
                    var newParams_1 = Object.assign({}, PoPageBlockedUserParamsDefault);
        ...
        Object.defineProperty(PoPageBlockedUserBaseComponent.prototype, "reason", {
             ...
             */
            set: function (value) {
                this._reason = Object.values(exports.PoPageBlockedUserReason).includes(value)
                    ? value
    ...
    PoPageBlockedUserBaseComponent.propDecorators = {
        contactEmail: [{ type: i0.Input, args: ['p-contact-email',] }],
        contactPhone: [{ type: i0.Input, args: ['p-contact-phone',] }],
        logo: [{ type: i0.Input, args: ['p-logo',] }],
        secondaryLogo: [{ type: i0.Input, args: ['p-secondary-logo',] }],
        params: [{ type: i0.Input, args: ['p-params',] }],
        reason: [{ type: i0.Input, args: ['p-reason',] }],
        urlBack: [{ type: i0.Input, args: ['p-url-back',] }]
    };
    ...
    var PoPageBlockedUserComponent = /** @class */ (function (_super) {
        ...
        function PoPageBlockedUserComponent(activatedRoute, router, languageService) {
            var _this = _super.call(this) || this;
            _this.activatedRoute = activatedRoute;
            _this.router = router;
            var language = languageService.getShortLanguage();
            _this.literals = Object.assign(Object.assign({}, poPageBlockedUserButtonLiterals[i2.poLocaleDefault]), poPageBlockedUserButtonLiterals[language]);
            return _this;
        }
    ...
    PoPageBlockedUserContactsComponent.propDecorators = {
        contactGroup: [{ type: i0.ViewChild, args: ['contactGroup', { static: true },] }],
        mailItem: [{ type: i0.ViewChild, args: ['mailItem', { static: true },] }],
        phoneItem: [{ type: i0.ViewChild, args: ['phoneItem', { static: true },] }],
        email: [{ type: i0.Input, args: ['p-email',] }],
        phone: [{ type: i0.Input, args: ['p-phone',] }]
    };
    ...
    var PoPageBlockedUserReasonComponent = /** @class */ (function () {
        function PoPageBlockedUserReasonComponent(changeDetector, languageService) {
            this.changeDetector = changeDetector;
        ...
        PoPageBlockedUserReasonComponent.prototype.getLiterals = function () {
            this.getParams();
            this.literals = Object.assign(Object.assign({}, poPageBlockedUserLiterals[this.reason][i2.poLocaleDefault]), poPageBlockedUserLiterals[this.reason][this.language]);
            this.changeDetector.detectChanges();
        };
    ...
    PoPageBlockedUserModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [common.CommonModule, router.RouterModule, i2.PoModule, PoPageBackgroundModule],
    ...
    PoPageChangePasswordBaseComponent.propDecorators = {
        logo: [{ type: i0.Input, args: ['p-logo',] }],
        secondaryLogo: [{ type: i0.Input, args: ['p-secondary-logo',] }],
        token: [{ type: i0.Input, args: ['p-token',] }],
        urlBack: [{ type: i0.Input, args: ['p-url-back',] }],
        urlNewPassword: [{ type: i0.Input, args: ['p-url-new-password',] }],
        submit: [{ type: i0.Output, args: ['p-submit',] }],
        hideCurrentPassword: [{ type: i0.Input, args: ['p-hide-current-password',] }],
        recovery: [{ type: i0.Input, args: ['p-recovery',] }],
        requirements: [{ type: i0.Input, args: ['p-requirements',] }],
        urlHome: [{ type: i0.Input, args: ['p-url-home',] }]
    };
    ...
    var PoPageChangePasswordComponent = /** @class */ (function (_super) {
        ...
        function PoPageChangePasswordComponent(activatedRoute, route, router, service, poComponentInjector, languageService, viewRef) {
            var _this = _super.call(this) || this;
            _this.activatedRoute = activatedRoute;
            _this.route = route;
            _this.router = router;
            ...
            _this.literals = poPageChangePasswordLiterals[i2.poLocaleDefault];
            _this.modalAction = {
            ...
            var language = languageService.getShortLanguage();
            _this.literals = Object.assign(Object.assign({}, poPageChangePasswordLiterals[i2.poLocaleDefault]), poPageChangePasswordLiterals[language]);
            return _this;
        }
        ...
        PoPageChangePasswordComponent.prototype.createModalPasswordRecoveryComponent = function (recovery) {
            ...
            this.componentRef.instance.type = recovery.type || exports.PoModalPasswordRecoveryType.Email;
    ...
    PoPageChangePasswordComponent.ctorParameters = function () { return [
        ...
        { type: i2.PoComponentInjectorService },
        { type: i2.PoLanguageService },
        { type: i0.ViewContainerRef }
    ]; };
    PoPageChangePasswordComponent.propDecorators = {
        modal: [{ type: i0.ViewChild, args: [i2.PoModalComponent, { static: true },] }],
        pageChangePassword: [{ type: i0.ViewChild, args: ['pageChangePassword', { read: i0.ViewContainerRef, static: true },] }],
        passwordForm: [{ type: i0.ViewChild, args: ['passwordForm', { read: forms.NgForm, static: true },] }]
    };
    ...
    PoPageChangePasswordModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [common.CommonModule, forms.FormsModule, router.RouterModule, i2.PoModule, PoPageBackgroundModule],
    ...
    var PoPageDynamicService = /** @class */ (function () {
        ...
        PoPageDynamicService.prototype.getMetadata = function (type) {
            ...
            return this.http.get(url).pipe(operators.map(function (response) {
                ...
                return rxjs.merge(rxjs.of({ title: errorRenderPage }), rxjs.throwError(error));
            }));
        };
        // Deleta um único recurso
        PoPageDynamicService.prototype.deleteResource = function (id, endpoint) {
            var localEndPoint = this.getLocalEndPoint(endpoint, true);
            var url = id ? localEndPoint + "/" + id : localEndPoint;
    ...
    PoPageDynamicService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PoPageDynamicService_Factory() { return new PoPageDynamicService(i0__namespace.ɵɵinject(i1__namespace.HttpClient), i0__namespace.ɵɵinject(i2__namespace.PoNotificationService), i0__namespace.ɵɵinject(i2__namespace.PoLanguageService)); }, token: PoPageDynamicService, providedIn: "root" });
    ...
    var PoPageDynamicDetailActionsService = /** @class */ (function () {
        ...
        PoPageDynamicDetailActionsService.prototype.executeAction = function (_a) {
            ...
            return rxjs.of(action(id, resource));
        };
        return PoPageDynamicDetailActionsService;
    }());
    PoPageDynamicDetailActionsService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PoPageDynamicDetailActionsService_Factory() { return new PoPageDynamicDetailActionsService(i0__namespace.ɵɵinject(i1__namespace.HttpClient)); }, token: PoPageDynamicDetailActionsService, providedIn: "root" });
    ...
    var PoPageCustomizationService = /** @class */ (function () {
        ...
        PoPageCustomizationService.prototype.getCustomOptions = function (origin, originalOption, optionSchema) {
            var _this = this;
            return this.createObservable(origin).pipe(operators.map(function (newPageOptions) { return _this.mergePageOptions(originalOption, newPageOptions, optionSchema); }));
        };
            ...
            Object.keys(newOptions).forEach(function (key) {
                ...
                if (key in objectToChange) {
                    if (Array.isArray(value)) {
                        objectToChange[key] = __spreadArray([], __read(value));
                        return;
                    }
        ...
        PoPageCustomizationService.prototype.mergePageOptions = function (originalOption, newPageOptions, optionSchema) {
            ...
            var mergePageOptions = optionSchema.schema.reduce(function (objWithNewProp, prop) {
                var _b;
                return (Object.assign(Object.assign({}, objWithNewProp), (_b = {}, _b[prop.nameProp] = _this.createNewProp(prop, originalOption, newPageOptions), _b)));
            }, {});
        ...
        PoPageCustomizationService.prototype.mergeOptionsArray = function (originalOptions, newOptions, filterProp) {
            ...
            return __spreadArray(__spreadArray([], __read(mergedOriginalOptions)), __read(deduplicateNewOptions));
        };
        return PoPageCustomizationService;
    }());
    PoPageCustomizationService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PoPageCustomizationService_Factory() { return new PoPageCustomizationService(i0__namespace.ɵɵinject(i1__namespace.HttpClient)); }, token: PoPageCustomizationService, providedIn: "root" });
    ...
    var PoPageDynamicDetailComponent = /** @class */ (function () {
        function PoPageDynamicDetailComponent(router, activatedRoute, poNotification, poDialogService, poPageDynamicService, poPageDynamicDetailActionsService, poPageCustomizationService, languageService) {
            this.router = router;
            ...
            this._pageActions = [];
            var language = languageService.getShortLanguage();
            this.literals = Object.assign(Object.assign({}, poPageDynamicDetailLiteralsDefault[i2.poLocaleDefault]), poPageDynamicDetailLiteralsDefault[language]);
        }
        ...
        Object.defineProperty(PoPageDynamicDetailComponent.prototype, "duplicates", {
            get: function () {
                return __spreadArray([], __read(this._duplicates));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoPageDynamicDetailComponent.prototype, "keys", {
            get: function () {
                return __spreadArray([], __read(this._keys));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoPageDynamicDetailComponent.prototype, "pageActions", {
            get: function () {
                return __spreadArray([], __read(this._pageActions));
            },
            enumerable: false,
            configurable: true
        });
        PoPageDynamicDetailComponent.prototype.remove = function (actionRemove, actionBeforeRemove) {
            ...
            this.subscriptions.push(this.poPageDynamicDetailActionsService
                ...
                .pipe(operators.switchMap(function (beforeRemoveResult) {
                var _a, _b;
                ...
                if (typeof newRemoveAction === 'string') {
                    ...
                    newRemoveAction(uniqueKey, Object.assign({}, _this.model));
                    return rxjs.EMPTY;
                }
            }))
                .subscribe());
        ...
        PoPageDynamicDetailComponent.prototype.executeRemove = function (path, uniqueKey) {
            var _this = this;
            return this.poPageDynamicService.deleteResource(uniqueKey).pipe(operators.map(function () {
        ...
        PoPageDynamicDetailComponent.prototype.goBack = function (actionBack) {
            ...
            this.subscriptions.push(this.poPageDynamicDetailActionsService
                ...
                .subscribe(function (beforeBackResult) { return _this.executeBackAction(actionBack, beforeBackResult === null || beforeBackResult === void 0 ? void 0 : beforeBackResult.allowAction, beforeBackResult === null || beforeBackResult === void 0 ? void 0 : beforeBackResult.newUrl); }));
        };
        ...
        PoPageDynamicDetailComponent.prototype.loadData = function (id) {
            var _this = this;
            return this.poPageDynamicService.getResource(id).pipe(operators.tap(function (response) {
                if (!response) {
        ...
        PoPageDynamicDetailComponent.prototype.getMetadata = function (serviceApiFromRoute, onLoad) {
            ...
            if (serviceApiFromRoute) {
                return this.poPageDynamicService.getMetadata('detail').pipe(operators.tap(function (response) {
                ...
                }), operators.switchMap(function () { return _this.loadOptionsOnInitialize(onLoad); }));
            }
        ...
        PoPageDynamicDetailComponent.prototype.openEdit = function (action) {
            ...
            this.subscriptions.push(this.poPageDynamicDetailActionsService
                ...
                .pipe(operators.switchMap(function (beforeEditResult) { return _this.executeEditAction(action, beforeEditResult, id); }))
                .subscribe());
        };
        ...
        PoPageDynamicDetailComponent.prototype.loadDataFromAPI = function () {
            var _c = this.activatedRoute.snapshot.data, serviceApiFromRoute = _c.serviceApi, serviceMetadataApi = _c.serviceMetadataApi, serviceLoadApi = _c.serviceLoadApi;
        ...
        PoPageDynamicDetailComponent.prototype.loadOptionsOnInitialize = function (onLoad) {
            var _this = this;
            if (onLoad) {
                return this.getPoDynamicPageOptions(onLoad).pipe(operators.tap(function (responsePoOption) { return _this.poPageCustomizationService.changeOriginalOptionsToNewOptions(_this, responsePoOption); }));
            }
            return rxjs.EMPTY;
        };
    ...
    var PoPageDynamicEditActionsService = /** @class */ (function () {
        ...
        PoPageDynamicEditActionsService.prototype.executeAction = function (_a) {
            ...
            return rxjs.of(action(resource, id));
        };
        return PoPageDynamicEditActionsService;
    }());
    PoPageDynamicEditActionsService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PoPageDynamicEditActionsService_Factory() { return new PoPageDynamicEditActionsService(i0__namespace.ɵɵinject(i1__namespace.HttpClient)); }, token: PoPageDynamicEditActionsService, providedIn: "root" });
    ...
    var PoPageDynamicEditComponent = /** @class */ (function () {
        function PoPageDynamicEditComponent(router, activatedRoute, poNotification, poDialogService, poPageDynamicService, poPageCustomizationService, poPageDynamicEditActionsService, languageService) {
            this.router = router;
            this.activatedRoute = activatedRoute;
            this.poNotification = poNotification;
            this.poDialogService = poDialogService;
            ...
            this._pageActions = [];
            var language = languageService.getShortLanguage();
            this.literals = Object.assign(Object.assign({}, poPageDynamicEditLiteralsDefault[i2.poLocaleDefault]), poPageDynamicEditLiteralsDefault[language]);
        }
        ...
        PoPageDynamicEditComponent.prototype.loadData = function (id, duplicate) {
            ...
            return this.poPageDynamicService.getResource(id).pipe(operators.tap(function (response) { return (_this.model = response); }), operators.catchError(function (error) {
        ...
        PoPageDynamicEditComponent.prototype.getMetadata = function (serviceApiFromRoute, paramId, onLoad) {
            ...
            if (serviceApiFromRoute) {
                return this.poPageDynamicService.getMetadata(typeMetadata).pipe(operators.tap(function (response) {
                    _this.autoRouter = response.autoRouter || _this.autoRouter;
                    _this.actions = response.actions || _this.actions;
                    _this.breadcrumb = response.breadcrumb || _this.breadcrumb;
                    _this.fields = response.fields || _this.fields;
        ...
        PoPageDynamicEditComponent.prototype.executeSave = function (saveRedirectPath) {
            ...
            return saveOperation$.pipe(operators.tap(function (message) {
        ...
        PoPageDynamicEditComponent.prototype.saveOperation = function () {
            ...
            return saveOperation$.pipe(operators.map(function () { return successMsg; }));
        };
        PoPageDynamicEditComponent.prototype.save = function (action, before) {
            ...
            this.subscriptions.push(this.poPageDynamicEditActionsService[before](this.actions[before], uniqueKey, Object.assign({}, this.model))
                .pipe(operators.switchMap(function (returnBefore) {
                var _a, _b;
                ...
                if (typeof newAction === 'string') {
                    ...
                    newAction(Object.assign({}, _this.model), uniqueKey);
                    return rxjs.EMPTY;
                }
            }))
                .subscribe());
    ...
    PoPageDynamicEditComponent.propDecorators = {
        ...
        gridDetail: [{ type: i0.ViewChild, args: ['gridDetail',] }],
        breadcrumb: [{ type: i0.Input, args: ['p-breadcrumb',] }],
        serviceApi: [{ type: i0.Input, args: ['p-service-api',] }],
        title: [{ type: i0.Input, args: ['p-title',] }],
        onLoad: [{ type: i0.Input, args: ['p-load',] }],
    ...
    var PoAdvancedFilterBaseComponent = /** @class */ (function () {
        function PoAdvancedFilterBaseComponent(languageService) {
            ...
            this.filter = {};
            this.language = i2.poLocaleDefault;
            this.primaryAction = {
                action: function () {
        ...
        Object.defineProperty(PoAdvancedFilterBaseComponent.prototype, "filters", {
            ...
            set: function (filters) {
                this._filters = Array.isArray(filters) ? __spreadArray([], __read(filters)) : [];
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoAdvancedFilterBaseComponent.prototype, "literals", {
            ...
            set: function (value) {
                if (value instanceof Object && !(value instanceof Array)) {
                    this._literals = Object.assign(Object.assign(Object.assign({}, poAdvancedFiltersLiteralsDefault[i2.poLocaleDefault]), poAdvancedFiltersLiteralsDefault[this.language]), value);
                }
                else {
        ...
        PoAdvancedFilterBaseComponent.prototype.getValuesFromForm = function () {
            ...
            if (this.optionsServiceChosenOptions.length) {
                optionServiceOptions = this.optionsServiceChosenOptions.filter(function (optionItem) { return Object.values(_this.filter).includes(optionItem.value); });
            }
    ...
    PoAdvancedFilterBaseComponent.propDecorators = {
        poModal: [{ type: i0.ViewChild, args: [i2.PoModalComponent, { static: true },] }],
        keepFilters: [{ type: i0.Input, args: ['p-keep-filters',] }],
        searchEvent: [{ type: i0.Output, args: ['p-search-event',] }],
        filters: [{ type: i0.Input, args: ['p-filters',] }],
    ...
    var PoAdvancedFilterComponent = /** @class */ (function (_super) {
        ...
        PoAdvancedFilterComponent.prototype.ngOnInit = function () {
            this.optionsServiceSubscribe();
        };
        PoAdvancedFilterComponent.prototype.ngOnDestroy = function () {
        ...
        PoAdvancedFilterComponent.prototype.getOptionsServiceItem = function (optionServiceObject) {
            var objectItem = this.optionsServiceChosenOptions.map(function (option) { return option.value; }).indexOf(optionServiceObject.value);
            if (objectItem === -1) {
                this.optionsServiceChosenOptions = __spreadArray(__spreadArray([], __read(this.optionsServiceChosenOptions)), [optionServiceObject]);
            }
        };
        ...
        PoAdvancedFilterComponent.prototype.optionsServiceSubscribe = function () {
            var _this = this;
            this.subscription.add(this.poDynamicForm.getObjectValue().subscribe(function (optionServiceObject) {
                if (optionServiceObject) {
                    _this.getOptionsServiceItem(optionServiceObject);
                }
            }));
        };
    ...
    PoAdvancedFilterComponent.propDecorators = {
        poDynamicForm: [{ type: i0.ViewChild, args: [i2.PoDynamicFormComponent, { static: true },] }]
    };
    ...
    var PoPageDynamicSearchBaseComponent = /** @class */ (function () {
        function PoPageDynamicSearchBaseComponent(languageService) {
             ...
             */
            this.changeDisclaimers = new i0.EventEmitter();
            /**
             * @optional
             *
             * @description
             ...
             */
            this.quickSearch = new i0.EventEmitter();
            this._filters = [];
            this.language = languageService.getShortLanguage();
        }
        Object.defineProperty(PoPageDynamicSearchBaseComponent.prototype, "literals", {
            ...
            set: function (value) {
                if (value instanceof Object && !(value instanceof Array)) {
                    this._literals = Object.assign(Object.assign(Object.assign({}, poPageDynamicSearchLiteralsDefault[i2.poLocaleDefault]), poPageDynamicSearchLiteralsDefault[this.language]), value);
                }
                else {
        ...
        Object.defineProperty(PoPageDynamicSearchBaseComponent.prototype, "filters", {
            ...
            set: function (filters) {
                ...
                if (this.stringify(this._filters) !== this.stringify(this.previousFilters)) {
                    ...
                    this.previousFilters = __spreadArray([], __read(this._filters));
                }
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoPageDynamicSearchBaseComponent.prototype, "quickSearchWidth", {
            get: function () {
        ...
        PoPageDynamicSearchBaseComponent.prototype.stringify = function (columns) {
    ...
    PoPageDynamicSearchBaseComponent.propDecorators = {
        ...
        breadcrumb: [{ type: i0.Input, args: ['p-breadcrumb',] }],
        keepFilters: [{ type: i0.Input, args: ['p-keep-filters',] }],
        concatFilters: [{ type: i0.Input, args: ['p-concat-filters',] }],
        onLoad: [{ type: i0.Input, args: ['p-load',] }],
        title: [{ type: i0.Input, args: ['p-title',] }],
        advancedSearch: [{ type: i0.Output, args: ['p-advanced-search',] }],
        changeDisclaimers: [{ type: i0.Output, args: ['p-change-disclaimers',] }],
        quickSearch: [{ type: i0.Output, args: ['p-quick-search',] }],
        literals: [{ type: i0.Input, args: ['p-literals',] }],
        filters: [{ type: i0.Input, args: ['p-filters',] }],
        quickSearchWidth: [{ type: i0.Input, args: ['p-quick-search-width',] }]
    };
    __decorate([
        i2.InputBoolean()
    ...
    var PoPageDynamicSearchComponent = /** @class */ (function (_super) {
        ...
        PoPageDynamicSearchComponent.prototype.onChangeFilters = function (filters) {
            var filterObjectWithValue = filters
                ...
                var _a;
                return (Object.assign(Object.assign({}, prev), (_a = {}, _a[current.property] = current.initValue, _a)));
            }, {});
        ...
        PoPageDynamicSearchComponent.prototype.onAction = function (quickFilter) {
            ...
            var getDisclaimersWithConcatFilters = function () { return __spreadArray(__spreadArray([], __read(_this.getDisclaimersWithoutQuickSearch())), [
        ...
        PoPageDynamicSearchComponent.prototype.onAdvancedSearch = function (filteredItems) {
            var filter = filteredItems.filter, optionsService = filteredItems.optionsService;
        ...
        PoPageDynamicSearchComponent.prototype.optionsServiceDisclaimerLabel = function (value, optionsServiceObjectsList) {
            var optionServiceMatch = optionsServiceObjectsList.find(function (option) { return option.value === value; });
        ...
        PoPageDynamicSearchComponent.prototype.getFilterValueToDisclaimer = function (field, value, optionsServiceObjectsList) {
        ...
        PoPageDynamicSearchComponent.prototype.setDisclaimers = function (filters, optionsServiceObjects) {
            var _this = this;
            var disclaimers = [];
            ...
            properties.forEach(function (property) {
                ...
                var valueDisplayedOnTheDisclaimerLabel = _this.getFilterValueToDisclaimer(field, value, optionsServiceObjects);
        ...
        PoPageDynamicSearchComponent.prototype.loadOptionsOnInitialize = function (onLoad) {
            var _this = this;
            this.loadSubscription = this.getPoDynamicPageOptions(onLoad).subscribe(function (responsePoOption) { return _this.poPageCustomizationService.changeOriginalOptionsToNewOptions(_this, responsePoOption); });
        };
    ...
    PoPageDynamicSearchComponent.propDecorators = {
        poAdvancedFilter: [{ type: i0.ViewChild, args: [PoAdvancedFilterComponent, { static: true },] }]
    };
    ...
    var PoPageDynamicListBaseComponent = /** @class */ (function () {
        ...
        Object.defineProperty(PoPageDynamicListBaseComponent.prototype, "duplicates", {
            ...
            set: function (value) {
                this._duplicates = __spreadArray([], __read(value));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoPageDynamicListBaseComponent.prototype, "filters", {
            ...
            set: function (value) {
                this._filters = __spreadArray([], __read(value));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoPageDynamicListBaseComponent.prototype, "keys", {
            ...
            set: function (value) {
                this._keys = __spreadArray([], __read(value));
            },
            enumerable: false,
            configurable: true
        });
        PoPageDynamicListBaseComponent.prototype.setFieldsProperties = function (fields) {
            this.filters = fields
                .filter(function (field) { return field.filter === true; })
                .map(function (filterField) { return (Object.assign(Object.assign({}, filterField), { visible: true })); });
            this.columns = fields.filter(function (field) { return field.visible === undefined || field.visible === true || field.allowColumnsManager === true; });
            this.keys = fields.filter(function (field) { return field.key === true; }).map(function (field) { return field.property; });
            this.duplicates = fields.filter(function (field) { return field.duplicate === true; }).map(function (field) { return field.property; });
        };
    ...
    var PoPageDynamicTableActionsService = /** @class */ (function () {
        ...
        PoPageDynamicTableActionsService.prototype.customAction = function (action, resource) {
            if (resource === void 0) { resource = []; }
            return this.executeAction({ action: action, resource: resource });
        };
        PoPageDynamicTableActionsService.prototype.executeAction = function (_a) {
            ...
            return rxjs.of(action(resource));
        };
        return PoPageDynamicTableActionsService;
    }());
    PoPageDynamicTableActionsService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PoPageDynamicTableActionsService_Factory() { return new PoPageDynamicTableActionsService(i0__namespace.ɵɵinject(i1__namespace.HttpClient)); }, token: PoPageDynamicTableActionsService, providedIn: "root" });
    ...
    var PoPageDynamicTableComponent = /** @class */ (function (_super) {
        ...
        function PoPageDynamicTableComponent(router, activatedRoute, poDialogService, poNotification, poPageDynamicService, poPageCustomizationService, poPageDynamicTableActionsService, languageService) {
            var _this = _super.call(this) || this;
            _this.router = router;
            _this.activatedRoute = activatedRoute;
            ...
            _this.tableActions = [];
            _this._actions = {};
            _this._pageCustomActions = [];
            _this._tableCustomActions = [];
            _this.page = 1;
            _this.params = {};
            _this.subscriptions = new rxjs.Subscription();
            _this.hasCustomActionWithSelectable = false;
            _this._customPageListActions = [];
            _this._customTableActions = [];
            _this._defaultPageActions = [];
            _this._defaultTableActions = [];
            var language = languageService.getShortLanguage();
            _this.literals = Object.assign(Object.assign({}, poPageDynamicTableLiteralsDefault[i2.poLocaleDefault]), poPageDynamicTableLiteralsDefault[language]);
            return _this;
        }
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "defaultPageActions", {
            set: function (value) {
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "defaultTableActions", {
            set: function (value) {
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "customPageListActions", {
            set: function (value) {
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "customTableActions", {
            set: function (value) {
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "pageCustomActions", {
            get: function () {
            ...
            set: function (value) {
                ...
                this.hasCustomActionWithSelectable = this.pageCustomActions.some(function (customAction) { return customAction.selectable; });
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "tableCustomActions", {
            get: function () {
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "quickSearchWidth", {
            get: function () {
                return this._quickSearchWidth;
            },
            /**
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "enableSelectionTable", {
            get: function () {
        ...
        PoPageDynamicTableComponent.prototype.getOrderParam = function (sortedColumn) {
            ...
            if (type === i2.PoTableColumnSortType.Descending) {
        ...
        PoPageDynamicTableComponent.prototype.loadData = function (params) {
            ...
            var fullParams = Object.assign(Object.assign(Object.assign({}, defaultParams), params), orderParam);
            return this.poPageDynamicService.getResources(fullParams).pipe(operators.tap(function (response) {
                _this.items = fullParams.page === 1 ? response.items : __spreadArray(__spreadArray([], __read(_this.items)), __read(response.items));
        ...
        PoPageDynamicTableComponent.prototype.getMetadata = function (serviceApiFromRoute, onLoad) {
            var _this = this;
            if (serviceApiFromRoute) {
                return this.poPageDynamicService.getMetadata().pipe(operators.tap(function (response) {
                    _this.autoRouter = response.autoRouter || _this.autoRouter;
                    _this.actions = response.actions || _this.actions;
                    _this.breadcrumb = response.breadcrumb || _this.breadcrumb;
                    _this.fields = response.fields || _this.fields;
                    _this.title = response.title || _this.title;
                    _this.pageCustomActions = response.pageCustomActions || _this.pageCustomActions;
                    _this.tableCustomActions = response.tableCustomActions || _this.tableCustomActions;
                    _this.keepFilters = response.keepFilters || _this.keepFilters;
                    _this.concatFilters = response.concatFilters || _this.concatFilters;
                    _this.quickSearchWidth = response.quickSearchWidth || _this.quickSearchWidth;
                }), operators.switchMap(function () { return _this.loadOptionsOnInitialize(onLoad); }));
            }
            return this.loadOptionsOnInitialize(onLoad);
        };
        ...
        PoPageDynamicTableComponent.prototype.openDetail = function (action, item) {
            ...
            this.subscriptions.add(this.poPageDynamicTableActionsService
                ...
                .subscribe(function (beforeDetailResult) { return _this.executeDetail(action, beforeDetailResult, id, item); }));
        };
        ...
        PoPageDynamicTableComponent.prototype.openDuplicate = function (actionDuplicate, item) {
            ...
            this.subscriptions.add(this.poPageDynamicTableActionsService
                ...
                .subscribe(function (beforeDuplicateResult) { return _this.executeDuplicate(actionDuplicate, beforeDuplicateResult, duplicates); }));
        };
        ...
        PoPageDynamicTableComponent.prototype.openEdit = function (actionEdit, item) {
            ...
            this.subscriptions.add(this.poPageDynamicTableActionsService
                ...
                .pipe(operators.switchMap(function (beforeEditResult) { return _this.executeEditAction(actionEdit, beforeEditResult, item, id); }))
                .subscribe());
        };
        ...
        PoPageDynamicTableComponent.prototype.remove = function (item, actionRemove, actionBeforeRemove) {
            ...
            this.subscriptions.add(this.poPageDynamicTableActionsService
                ...
                .pipe(operators.switchMap(function (beforeRemove) { return _this.deleteAction(item, actionRemove, beforeRemove); }))
                .subscribe());
        };
        PoPageDynamicTableComponent.prototype.deleteAction = function (item, actionRemove, beforeRemove) {
            var _this = this;
            var _c = beforeRemove || {}, allowAction = _c.allowAction, newUrl = _c.newUrl;
            ...
            if (allow) {
                ...
                if (typeof actionRemove === 'boolean' || newUrl) {
                    ...
                    return this.poPageDynamicService
                        ...
                        .pipe(operators.map(function () { return _this.removeFromUI(resourceToRemoveKey_1, _this.literals.removeSuccessNotification); }));
                }
                return rxjs.of(actionRemove(uniqueKey, item)).pipe(operators.tap(function (remove) {
        ...
        PoPageDynamicTableComponent.prototype.removeAll = function (actionRemoveAll, actionBeforeRemoveAll) {
            var _this = this;
            var originalResourcesKeys = this.getSelectedItemsKeys();
            this.subscriptions.add(this.poPageDynamicTableActionsService
                .beforeRemoveAll(actionBeforeRemoveAll, originalResourcesKeys)
                .pipe(operators.switchMap(function (beforeRemove) { return _this.deleteAllAction(actionRemoveAll, beforeRemove, originalResourcesKeys); }))
                .subscribe());
        };
        PoPageDynamicTableComponent.prototype.getSelectedItemsKeys = function () {
        ...
        PoPageDynamicTableComponent.prototype.deleteAllAction = function (actionRemoveAll, beforeRemoveAll, originalResources) {
            var _this = this;
            var _c = beforeRemoveAll !== null && beforeRemoveAll !== void 0 ? beforeRemoveAll : {}, allowAction = _c.allowAction, newUrl = _c.newUrl, resources = _c.resources;
            var allow = allowAction !== null && allowAction !== void 0 ? allowAction : true;
            ...
            if (allow && Array.isArray(resourcestoDelete)) {
                if (typeof actionRemoveAll === 'boolean' || newUrl) {
                    return this.poPageDynamicService.deleteResources(resourcestoDelete, newUrl).pipe(operators.tap(function () {
                        _this.removeFromUI(resourcestoDelete, _this.literals.removeAllSuccessNotification);
                    }));
                }
                return rxjs.of(actionRemoveAll(resourcestoDelete)).pipe(operators.tap(function (removeItems) { return _this.removeFromUI(removeItems, _this.literals.removeSuccessNotification); }));
            }
            return rxjs.of({});
        };
        ...
        PoPageDynamicTableComponent.prototype.transformCustomActionsToPageListAction = function (customActions) {
            var _this = this;
            return customActions.map(function (customAction) { return (Object.assign({ label: customAction.label, action: _this.callPageCustomAction.bind(_this, customAction), disabled: _this.isDisablePageCustomAction.bind(_this, customAction) }, (customAction.icon && { icon: customAction.icon }))); });
        };
        PoPageDynamicTableComponent.prototype.transformTableCustomActionsToTableActions = function (tableCustomActions) {
            var _this = this;
        ...
        PoPageDynamicTableComponent.prototype.callPageCustomAction = function (customAction) {
            if (customAction.action) {
                var selectedItems = customAction.selectable ? this.getSelectedItemsKeys() : undefined;
                var sendCustomActionSubscription = this.poPageDynamicTableActionsService
        ...
        PoPageDynamicTableComponent.prototype.callTableCustomAction = function (customAction, selectedItem) {
            var _this = this;
            if (customAction.action) {
                var sendCustomActionSubscription = this.poPageDynamicTableActionsService
                    ...
                    if (typeof updatedItem === 'object' && updatedItem !== null) {
                        _this.modifyUITableItem(selectedItem, removeKeysProperties(_this.keys, updatedItem));
                    }
                });
                this.subscriptions.add(sendCustomActionSubscription);
            }
        ...
        PoPageDynamicTableComponent.prototype.setRemoveAllAction = function () {
            ...
            if (this.showRemove(action.removeAll)) {
                this.defaultPageActions = __spreadArray(__spreadArray([], __read(this._defaultPageActions)), [
                    {
        ...
        PoPageDynamicTableComponent.prototype.loadDataFromAPI = function () {
            ...
            this.subscriptions.add(metadata$
                ...
                var initialFilters = _this.getInitialValuesFromFilter();
        ...
        PoPageDynamicTableComponent.prototype.getInitialValuesFromFilter = function () {
            var initialFilters = this.filters.reduce(function (result, item) {
                var _c;
                return Object.assign(result, (_c = {}, _c[item.property] = item.initValue, _c));
            }, {});
        ...
        PoPageDynamicTableComponent.prototype.updatePageActions = function () {
            this.pageActions = __spreadArray(__spreadArray([], __read(this._defaultPageActions)), __read(this._customPageListActions));
        };
        PoPageDynamicTableComponent.prototype.updateTableActions = function () {
            var _this = this;
            var defaultTableActionsWithoutActionDelete = this._defaultTableActions.filter(function (tableAction) { return tableAction.label !== _this.literals.tableActionDelete; });
            var tableActionDelete = this._defaultTableActions.find(function (tableAction) { return tableAction.label === _this.literals.tableActionDelete; });
            var newTableActions = __spreadArray(__spreadArray([], __read(defaultTableActionsWithoutActionDelete)), __read(this._customTableActions));
    ...
    PoPageDynamicTableComponent.propDecorators = {
        ...
        concatFilters: [{ type: i0.Input, args: ['p-concat-filters',] }],
        actions: [{ type: i0.Input, args: ['p-actions',] }],
        pageCustomActions: [{ type: i0.Input, args: ['p-page-custom-actions',] }],
        tableCustomActions: [{ type: i0.Input, args: ['p-table-custom-actions',] }],
        quickSearchWidth: [{ type: i0.Input, args: ['p-quick-search-width',] }]
    };
    __decorate([
        i2.InputBoolean()
    ...
    var PoPageJobSchedulerService = /** @class */ (function () {
        ...
        PoPageJobSchedulerService.prototype.getParametersByProcess = function (processId) {
            return this.http
                ...
                .pipe(operators.map(function (resource) { return resource.items; }));
        };
        // Busca um único recurso
        ...
        PoPageJobSchedulerService.prototype.getResource = function (id) {
            ...
            return this.http
                ...
                .pipe(operators.map(function (resource) { return _this.convertToJobSchedulerInternal(resource); }));
        };
        // Atualiza um recurso
        ...
        PoPageJobSchedulerService.prototype.convertToJobSchedulerInternal = function (jobScheduler) {
            ...
            var jobSchedulerInternal = Object.assign({}, jobScheduler);
        ...
        PoPageJobSchedulerService.prototype.convertToPeriodicityInternal = function (value) {
            ...
            if (value.monthly) {
                ...
                return {
                    ...
                    daysOfWeek: __spreadArray([], __read(value.weekly.daysOfWeek))
                };
            }
            else {
                return {
        ...
        PoPageJobSchedulerService.prototype.returnValidExecutionParameter = function (parameter) {
            var newParameter = Object.assign({}, parameter);
    ...
    var PoPageJobSchedulerLookupService = /** @class */ (function () {
        ...
        PoPageJobSchedulerLookupService.prototype.getFilteredItems = function (_a) {
            var filter = _a.filter, page = _a.page, pageSize = _a.pageSize;
            var params = { page: page, pageSize: pageSize, search: filter };
    ...
    var PoPageJobSchedulerComponent = /** @class */ (function (_super) {
        ...
        function PoPageJobSchedulerComponent(poPageDynamicLookupService, activatedRoute, poDialogService, poNotification, poPageJobSchedulerService, languageService) {
            ...
            _this.concludePageAction = {
                label: _this.literals.conclude,
                action: _this.confirmJobScheduler.bind(_this)
            };
            _this.nextPageAction = {
                label: _this.literals.next,
                action: _this.nextStepOperation.bind(_this, 'next'),
                disabled: _this.isDisabledAdvance.bind(_this)
            };
            _this.concludePageActions = [_this.concludePageAction, _this.backPageAction];
            _this.nextPageActions = [_this.nextPageAction, _this.backPageAction];
            // eslint-disable-next-line @typescript-eslint/member-ordering
            _this.jobSchedulerActions = __spreadArray([], __read(_this.nextPageActions));
            var language = languageService.getShortLanguage();
            _this.literals = Object.assign(Object.assign({}, _this.literals), poPageJobSchedulerLiteralsDefault[language]);
            _this.backPageAction.label = _this.literals.back;
            _this.concludePageAction.label = _this.literals.conclude;
            _this.nextPageAction.label = _this.literals.next;
            _this.steps = [
        ...
        PoPageJobSchedulerComponent.prototype.changePageActionsBySteps = function (currentStep, nextStep) {
            ...
            if (nextStep === stepsLength) {
                this.jobSchedulerActions = __spreadArray([], __read(this.concludePageActions));
            }
            else if (currentStep === stepsLength && nextStep < currentStep) {
                this.jobSchedulerActions = __spreadArray([], __read(this.nextPageActions));
            }
        };
        PoPageJobSchedulerComponent.prototype.nextStep = function (stepNumber) {
            ...
            if (steps) {
                steps.status = i2.PoStepperStatus.Done;
            }
        };
        ...
        PoPageJobSchedulerComponent.prototype.resetJobSchedulerForm = function () {
            ...
            setTimeout(function () {
                ...
                _this.steps.forEach(function (step) {
                    step.status = i2.PoStepperStatus.Default;
                });
                _this.jobSchedulerActions = __spreadArray([], __read(_this.nextPageActions));
            });
        };
    ...
    PoPageJobSchedulerComponent.propDecorators = {
        schedulerExecution: [{ type: i0.ViewChild, args: ['schedulerExecution', { static: true },] }],
        schedulerParameters: [{ type: i0.ViewChild, args: ['schedulerParameters',] }]
    };
    ...
    PoPageJobSchedulerExecutionComponent.propDecorators = {
        form: [{ type: i0.ViewChild, args: ['formExecution', { static: true },] }],
        dailyTemplate: [{ type: i0.ViewChild, args: ['dailyTemplate', { static: true },] }],
        monthlyTemplate: [{ type: i0.ViewChild, args: ['monthlyTemplate', { static: true },] }],
    ...
    PoPageJobSchedulerParametersComponent.propDecorators = {
        form: [{ type: i0.ViewChild, args: ['parametersForm',] }],
        literals: [{ type: i0.Input, args: ['p-literals',] }],
        parameters: [{ type: i0.Input, args: ['p-parameters',] }],
        value: [{ type: i0.Input, args: ['p-value',] }],
     ...
     */
    exports.PoPageLoginAuthenticationType = void 0;
    ...
    })(exports.PoPageLoginAuthenticationType || (exports.PoPageLoginAuthenticationType = {}));
    ...
    var PoPageLoginService = /** @class */ (function () {
        ...
        PoPageLoginService.prototype.onLogin = function (url, type, loginForm) {
            if (type === exports.PoPageLoginAuthenticationType.Bearer) {
    ...
    var PoPageLoginBaseComponent = /** @class */ (function () {
        function PoPageLoginBaseComponent(loginService, router, poLanguageService) {
             ...
             */
            this.loginChange = new i0.EventEmitter();
            /**
             ...
             *
             */
            this.languageChange = new i0.EventEmitter();
            this.allLoginErrors = [];
            this.allPasswordErrors = [];
            this.rememberUser = false;
            this.showExceededAttemptsWarning = false;
            this._authenticationType = exports.PoPageLoginAuthenticationType.Basic;
        ...
        Object.defineProperty(PoPageLoginBaseComponent.prototype, "authenticationType", {
             ...
             */
            set: function (value) {
                this._authenticationType = Object.values(exports.PoPageLoginAuthenticationType).includes(value)
                    ? value
                    : exports.PoPageLoginAuthenticationType.Basic;
            },
            enumerable: false,
            configurable: true
        });
        ...
        Object.defineProperty(PoPageLoginBaseComponent.prototype, "support", {
            get: function () {
        ...
        Object.defineProperty(PoPageLoginBaseComponent.prototype, "languagesList", {
            get: function () {
            ...
            set: function (languagesList) {
                ...
                if (languagesList) {
                    if (languagesList.length) {
                        ...
                        this._languagesList = i2.poLanguageDefault.filter(function (language) { return language.language === _this.language; });
                    }
                }
            },
            enumerable: false,
        ...
        Object.defineProperty(PoPageLoginBaseComponent.prototype, "showLanguage", {
            get: function () {
        ...
        Object.defineProperty(PoPageLoginBaseComponent.prototype, "pageLoginLiterals", {
            get: function () {
                var loginHintWithContactEmail = this.contactEmail
                    ...
                    : undefined;
                return Object.assign(Object.assign(Object.assign(Object.assign({}, poPageLoginLiteralsDefault[i2.poLocaleDefault]), poPageLoginLiteralsDefault[this.language]), loginHintWithContactEmail), this.literals);
            },
            enumerable: false,
            configurable: true
        });
    ...
    PoPageLoginBaseComponent.propDecorators = {
        background: [{ type: i0.Input, args: ['p-background',] }],
        logo: [{ type: i0.Input, args: ['p-logo',] }],
        loginPattern: [{ type: i0.Input, args: ['p-login-pattern',] }],
        passwordPattern: [{ type: i0.Input, args: ['p-password-pattern',] }],
        secondaryLogo: [{ type: i0.Input, args: ['p-secondary-logo',] }],
        loginChange: [{ type: i0.Output, args: ['p-login-change',] }],
        loginSubmit: [{ type: i0.Output, args: ['p-login-submit',] }],
        passwordChange: [{ type: i0.Output, args: ['p-password-change',] }],
        languageChange: [{ type: i0.Output, args: ['p-language-change',] }],
        customField: [{ type: i0.Input, args: ['p-custom-field',] }],
        contactEmail: [{ type: i0.Input, args: ['p-contact-email',] }],
        productName: [{ type: i0.Input, args: ['p-product-name',] }],
        environment: [{ type: i0.Input, args: ['p-environment',] }],
        exceededAttemptsWarning: [{ type: i0.Input, args: ['p-exceeded-attempts-warning',] }],
        hideRememberUser: [{ type: i0.Input, args: ['p-hide-remember-user',] }],
        literals: [{ type: i0.Input, args: ['p-literals',] }],
        loading: [{ type: i0.Input, args: ['p-loading',] }],
        login: [{ type: i0.Input, args: ['p-login',] }],
        loginErrors: [{ type: i0.Input, args: ['p-login-errors',] }],
        passwordErrors: [{ type: i0.Input, args: ['p-password-errors',] }],
        recovery: [{ type: i0.Input, args: ['p-recovery',] }],
        registerUrl: [{ type: i0.Input, args: ['p-register-url',] }],
        authenticationType: [{ type: i0.Input, args: ['p-authentication-type',] }],
        authenticationUrl: [{ type: i0.Input, args: ['p-authentication-url',] }],
        blockedUrl: [{ type: i0.Input, args: ['p-blocked-url',] }],
        support: [{ type: i0.Input, args: ['p-support',] }],
        languagesList: [{ type: i0.Input, args: ['p-languages',] }]
    };
    ...
    var PoPageLoginComponent = /** @class */ (function (_super) {
        ...
        function PoPageLoginComponent(changeDetector, activatedRoute, poComponentInjector, differs, loginService, router, poLanguageService) {
            var _this = _super.call(this, loginService, router, poLanguageService) || this;
            _this.changeDetector = changeDetector;
            _this.activatedRoute = activatedRoute;
            _this.poComponentInjector = poComponentInjector;
            _this.componentRef = null;
        ...
        PoPageLoginComponent.prototype.activateSupport = function () {
        ...
        PoPageLoginComponent.prototype.onSelectedLanguage = function (language) {
            this.languageChange.emit(this.languagesList.find(function (languageItem) { return languageItem.language === language; }));
        ...
        PoPageLoginComponent.prototype.createModalPasswordRecoveryComponent = function (poPageLoginRecovery) {
            ...
            this.componentRef.instance.type = poPageLoginRecovery.type || exports.PoModalPasswordRecoveryType.Email;
            this.componentRef.changeDetectorRef.detectChanges();
            setTimeout(function () {
                _this.componentRef.instance.open();
            });
        ...
        PoPageLoginComponent.prototype.setControlErrors = function (allErrors, control, errors, patternError) {
            if (control) {
                this[allErrors] = control.hasError('pattern') ? __spreadArray(__spreadArray([], __read(errors)), [patternError]) : __spreadArray([], __read(errors));
        ...
        PoPageLoginComponent.prototype.initializeLanguage = function () {
            var _this = this;
            var language = this.languagesList.find(function (languageItem) { return languageItem.language === _this.language; });
    ...
    PoPageLoginComponent.propDecorators = {
        loginForm: [{ type: i0.ViewChild, args: ['loginForm', { read: forms.NgForm, static: true },] }],
        pageLogin: [{ type: i0.ViewChild, args: ['pageLogin', { read: i0.ViewContainerRef, static: true },] }]
    };
    ...
    var PoPageLoginPopoverComponent = /** @class */ (function () {
        function PoPageLoginPopoverComponent() {
            ...
            this.forgotPassword = new i0.EventEmitter();
        }
    ...
    PoPageLoginPopoverComponent.propDecorators = {
        literals: [{ type: i0.Input, args: ['p-literals',] }],
        recovery: [{ type: i0.Input, args: ['p-recovery',] }],
        remainingAttempts: [{ type: i0.Input, args: ['p-remaining-attempts',] }],
        forgotPassword: [{ type: i0.Output, args: ['p-forgot-password',] }]
    };
    ...
    PoPageLoginModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [common.CommonModule, forms.FormsModule, router.RouterModule, PoPageBackgroundModule, i2.PoModule],
    ...
    exports.PoModalPasswordRecoveryErrorMessageComponent = PoModalPasswordRecoveryErrorMessageComponent;
    ...
    exports.PoPageBlockedUserContactsComponent = PoPageBlockedUserContactsComponent;
    exports.PoPageBlockedUserModule = PoPageBlockedUserModule;
    exports.PoPageBlockedUserReasonComponent = PoPageBlockedUserReasonComponent;
    ...
    exports.poPageDynamicLiterals = poPageDynamicLiterals;
    exports.ɵa = PoModalPasswordRecoveryBaseComponent;
    exports.ɵb = PoModalPasswordRecoveryService;
    exports.ɵc = PoPageBlockedUserBaseComponent;
    exports.ɵd = PoPageChangePasswordBaseComponent;
    exports.ɵe = PoPageChangePasswordService;
    exports.ɵf = PoPageDynamicDetailActionsService;
    exports.ɵg = PoPageDynamicEditActionsService;
    exports.ɵh = PoAdvancedFilterComponent;
    exports.ɵi = PoAdvancedFilterBaseComponent;
    exports.ɵj = PoPageDynamicSearchBaseComponent;
    exports.ɵk = PoPageDynamicListBaseComponent;
    exports.ɵl = PoPageDynamicTableActionsService;
...
//# sourceMappingURL=po-ui-ng-templates.umd.js.map
