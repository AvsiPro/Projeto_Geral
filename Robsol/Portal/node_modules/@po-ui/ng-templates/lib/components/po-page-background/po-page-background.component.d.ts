...
export declare class PoPageBackgroundComponent implements OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoPageBackgroundComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PoPageBackgroundComponent, "po-page-background", never, { "languagesList": "p-languages"; "logo": "p-logo"; "secondaryLogo": "p-secondary-logo"; "showSelectLanguage": "p-show-select-language"; "background": "p-background"; "initialSelectLanguage": "p-initial-language"; "hideLogo": "p-hide-logo"; "highlightInfo": "p-highlight-info"; }, { "selectedLanguage": "p-selected-language"; }, never, ["*"]>;
}

//# sourceMappingURL=po-page-background.component.d.ts.map