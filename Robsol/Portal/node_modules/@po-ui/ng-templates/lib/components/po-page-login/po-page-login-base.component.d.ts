...
export declare abstract class PoPageLoginBaseComponent implements OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoPageLoginBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoPageLoginBaseComponent, never, never, { "customField": "p-custom-field"; "contactEmail": "p-contact-email"; "productName": "p-product-name"; "environment": "p-environment"; "exceededAttemptsWarning": "p-exceeded-attempts-warning"; "hideRememberUser": "p-hide-remember-user"; "literals": "p-literals"; "loading": "p-loading"; "login": "p-login"; "loginErrors": "p-login-errors"; "passwordErrors": "p-password-errors"; "recovery": "p-recovery"; "registerUrl": "p-register-url"; "authenticationType": "p-authentication-type"; "authenticationUrl": "p-authentication-url"; "blockedUrl": "p-blocked-url"; "support": "p-support"; "languagesList": "p-languages"; "background": "p-background"; "logo": "p-logo"; "loginPattern": "p-login-pattern"; "passwordPattern": "p-password-pattern"; "secondaryLogo": "p-secondary-logo"; }, { "loginChange": "p-login-change"; "loginSubmit": "p-login-submit"; "passwordChange": "p-password-change"; "languageChange": "p-language-change"; }, never>;
}

//# sourceMappingURL=po-page-login-base.component.d.ts.map