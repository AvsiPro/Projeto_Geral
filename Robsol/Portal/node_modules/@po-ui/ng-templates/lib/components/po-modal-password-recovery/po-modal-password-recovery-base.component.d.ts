...
export declare abstract class PoModalPasswordRecoveryBaseComponent {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoModalPasswordRecoveryBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoModalPasswordRecoveryBaseComponent, never, never, { "contactEmail": "p-contact-email"; "phoneMask": "p-phone-mask"; "type": "p-type"; "codeError": "p-code-error"; "urlRecovery": "p-url-recovery"; }, { "codeSubmit": "p-code-submit"; "submit": "p-submit"; }, never>;
}

//# sourceMappingURL=po-modal-password-recovery-base.component.d.ts.map