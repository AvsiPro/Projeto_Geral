...
function default_1(options) {
    return schematics_1.chain([
        module_1.addModuleImportToRootModule(options, poTemplateModuleName, poTemplateModuleSourcePath),
...
function addPoPackageAndInstall() {
    return (tree, context) => {
        package_config_1.addPackageToPackageJson(tree, '@po-ui/ng-templates', '5.22.4');
        // install packages
