...
export declare abstract class PoLookupModalBaseComponent implements OnDestroy, OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoLookupModalBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoLookupModalBaseComponent, never, never, { "infiniteScroll": "p-infinite-scroll"; "multiple": "p-multiple"; "literals": "p-literals"; "title": "p-title"; "items": "p-items"; "advancedFilters": "p-advanced-filters"; "columns": "p-columns"; "filterService": "p-filter-service"; "filterParams": "p-filter-params"; "selectedItems": "p-selected-items"; "fieldLabel": "p-field-label"; "fieldValue": "p-field-value"; }, { "model": "p-change-model"; }, never>;
}

//# sourceMappingURL=po-lookup-modal-base.component.d.ts.map