...
export declare abstract class PoMultiselectBaseComponent implements ControlValueAccessor, OnInit, Validator {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoMultiselectBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoMultiselectBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "placeholder": "p-placeholder"; "placeholderSearch": "p-placeholder-search"; "filterService": "p-filter-service"; "autoHeight": "p-auto-height"; "options": "p-options"; "debounceTime": "p-debounce-time"; "literals": "p-literals"; "required": "p-required"; "disabled": "p-disabled"; "hideSearch": "p-hide-search"; "sort": "p-sort"; "filterMode": "p-filter-mode"; "fieldLabel": "p-field-label"; "fieldValue": "p-field-value"; "label": "p-label"; "help": "p-help"; "optional": "p-optional"; "name": "name"; "hideSelectAll": "p-hide-select-all"; }, { "change": "p-change"; }, never>;
}

//# sourceMappingURL=po-multiselect-base.component.d.ts.map