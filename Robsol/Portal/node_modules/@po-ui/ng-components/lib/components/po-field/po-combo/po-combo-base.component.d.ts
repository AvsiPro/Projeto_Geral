...
export declare abstract class PoComboBaseComponent implements ControlValueAccessor, OnInit, Validator {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoComboBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoComboBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "emitObjectValue": "p-emit-object-value"; "disabledTabFilter": "p-disabled-tab-filter"; "placeholder": "p-placeholder"; "debounceTime": "p-debounce-time"; "disabledInitFilter": "p-disabled-init-filter"; "fieldValue": "p-field-value"; "fieldLabel": "p-field-label"; "filterMinlength": "p-filter-minlength"; "required": "p-required"; "changeOnEnter": "p-change-on-enter"; "disabled": "p-disabled"; "sort": "p-sort"; "options": "p-options"; "filterMode": "p-filter-mode"; "filterParams": "p-filter-params"; "literals": "p-literals"; "label": "p-label"; "help": "p-help"; "name": "name"; "filterService": "p-filter-service"; "icon": "p-icon"; "optional": "p-optional"; "clean": "p-clean"; }, { "change": "p-change"; "ngModelChange": "ngModelChange"; }, never>;
}

//# sourceMappingURL=po-combo-base.component.d.ts.map