...
export declare abstract class PoDatepickerRangeBaseComponent implements ControlValueAccessor, Validator {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoDatepickerRangeBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoDatepickerRangeBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "clean": "p-clean"; "disabled": "p-disabled"; "endDate": "p-end-date"; "literals": "p-literals"; "minDate": "p-min-date"; "maxDate": "p-max-date"; "noAutocomplete": "p-no-autocomplete"; "readonly": "p-readonly"; "required": "p-required"; "startDate": "p-start-date"; "help": "p-help"; "label": "p-label"; "optional": "p-optional"; }, { "onChange": "p-change"; }, never>;
}

//# sourceMappingURL=po-datepicker-range-base.component.d.ts.map