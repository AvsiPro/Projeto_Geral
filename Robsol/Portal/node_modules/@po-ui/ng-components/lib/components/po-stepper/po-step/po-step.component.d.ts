...
export declare class PoStepComponent implements AfterContentInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoStepComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PoStepComponent, "po-step", never, { "status": "p-status"; "canActiveNextStep": "p-can-active-next-step"; "label": "p-label"; }, {}, never, ["*"]>;
}

//# sourceMappingURL=po-step.component.d.ts.map