...
export declare class PoGridComponent implements OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoGridComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PoGridComponent, "po-grid", never, { "rowActions": "p-row-actions"; "data": "p-data"; "columns": "p-columns"; }, {}, never, never>;
}

//# sourceMappingURL=po-grid.component.d.ts.map