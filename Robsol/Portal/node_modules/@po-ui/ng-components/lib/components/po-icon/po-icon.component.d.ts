...
export declare class PoIconComponent {
    ...
    private addClasses;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoIconComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PoIconComponent, "po-icon", never, { "icon": "p-icon"; }, {}, never, never>;
}

//# sourceMappingURL=po-icon.component.d.ts.map