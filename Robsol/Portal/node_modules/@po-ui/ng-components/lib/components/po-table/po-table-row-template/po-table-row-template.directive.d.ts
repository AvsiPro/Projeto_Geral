...
export declare class PoTableRowTemplateDirective {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoTableRowTemplateDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoTableRowTemplateDirective, "[p-table-row-template]", never, { "tableRowTemplateArrowDirection": "p-table-row-template-arrow-direction"; "poTableRowTemplateShow": "p-table-row-template-show"; }, {}, never>;
}

//# sourceMappingURL=po-table-row-template.directive.d.ts.map