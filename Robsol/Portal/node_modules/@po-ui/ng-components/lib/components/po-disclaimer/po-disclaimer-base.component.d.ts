...
export declare class PoDisclaimerBaseComponent {
    ...
    close(): void;
    getLabel(): string;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoDisclaimerBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PoDisclaimerBaseComponent, never, never, { "hideClose": "p-hide-close"; "type": "p-type"; "label": "p-label"; "value": "p-value"; "property": "p-property"; }, { "closeAction": "p-close-action"; }, never>;
}

//# sourceMappingURL=po-disclaimer-base.component.d.ts.map