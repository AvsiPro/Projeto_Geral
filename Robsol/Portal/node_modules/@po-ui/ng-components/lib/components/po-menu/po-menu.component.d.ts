...
export declare class PoMenuComponent extends PoMenuBaseComponent implements AfterViewInit, OnDestroy, OnInit, DoCheck {
    ...
    private updateMenu;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoMenuComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PoMenuComponent, "po-menu", never, {}, {}, ["menuHeaderTemplate"], never>;
}

//# sourceMappingURL=po-menu.component.d.ts.map