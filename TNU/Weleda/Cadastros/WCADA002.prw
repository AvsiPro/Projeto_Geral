...
Local aRot := {}
    ...
    ADD OPTION aRot TITLE 'Validar Json Envio'  ACTION 'U_xWcada2(Z92->Z92_COD)'          OPERATION MODEL_OPERATION_VIEW      ACCESS 0 //OPERATION 3
    ADD OPTION aRot TITLE 'Validar Json Retorno'  ACTION 'U_xWcada3(Z92->Z92_COD)'          OPERATION MODEL_OPERATION_VIEW      ACCESS 0 //OPERATION 3
