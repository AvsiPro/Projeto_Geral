...
Static Function MontaRel()
	...
	Do While !EOF()
		...
		ElseIf Alltrim(SA6->A6_COD)=="033"
			...
			cMulta := 2
			cInst0:= "APÓS O VENCIMENTO MORA DIA R$ " + transform(SE1->E1_SALDO*(cJurDia/100),'@E 999999.99')
			cInst1:= "APÓS O VENCIMENTO MULTA DE R$ " + transform(SE1->E1_SALDO*(cMulta/100),'@E 999999.99') //strtran(SEE->EE_FORMEN1,"'","")
			//cInst2:= strtran(SEE->EE_FORMEN2,"'","")
			cInst2:= "TITULO REGISTRADO: PROTESTO APÓS 5 DIAS UTEIS DO VENCIMENTO." //strtran(SEE->EE_FORMEN2,"'","")
			cInst3:= "OBS.: NÃO ACEITAMOS DEPOSITO EM CONTA CORRENTE." //strtran(SEE->EE_FOREXT1,"'","")
